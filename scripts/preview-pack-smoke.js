...
const SCHEMA_VERSION = 'oas.preview-pack-smoke.v1';
...
const HERMES_BOUNDARY_MARKERS = [
  ...
  'OAS v2.0.0-rc.1 documents the Hermes surface',
...
function usage() {
  console.log([
    ...
    '',
    'Deterministic smoke gate for the OAS 2.0 rc.1 preview pack.',
    '',
    'Options:',
