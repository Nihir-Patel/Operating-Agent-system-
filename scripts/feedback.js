...
Usage: oas feedback [--json] [--help|-h]

Print OAS's low-friction public feedback routes. This command never uploads
...
function printHuman() {
  process.stdout.write([
    ...
    '',
    'OAS does not upload diagnostics or read project files. Redact sensitive information before posting publicly.',
    '',
  ].join('\n'));
}
