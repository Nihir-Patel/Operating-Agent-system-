...
# Install OAS git safety hooks globally via core.hooksPath.
# Usage:
...
DEST_DIR="${OAS_GLOBAL_HOOKS_DIR:-$HOME/.codex/git-hooks}"
...
log "Installed OAS global git hooks."
log "Disable per repo by creating .oas-hooks-disable in project root."
log "Temporary bypass: OAS_SKIP_PRECOMMIT=1 or OAS_SKIP_PREPUSH=1"
