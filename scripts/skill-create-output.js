...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  OAS Skill Creator                                             ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by Operating Agent Systems • oas.tools`));
