 ...
 *
 * Bootstrap loader for the OAS SessionStart hook.
 *
 ...
 *   2. Resolves the OAS plugin root directory (via CLAUDE_PLUGIN_ROOT env var
...
const { resolveEccRoot } = require('../lib/resolve-oas-root');
...
// Resolve the OAS plugin root via the shared resolver, probing for the runner
...
process.stderr.write(
  '[SessionStart] WARNING: could not resolve OAS plugin root; skipping session-start hook\n'
);
process.stdout.write(raw);
