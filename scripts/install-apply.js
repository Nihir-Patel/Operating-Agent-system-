#!/usr/bin/env node
/**
 * Refactored OAS installer runtime.
 *
...
Targets:
  claude       (default) - Install OAS into ~/.claude/ with managed rules under rules/oas and flat skills under skills/
  claude-project - Install OAS into ./.claude/ (per-project) with managed rules under rules/oas and flat skills under skills/
  ...
  kimi         - Install Kimi Code project instructions, skills, and MCP config into ./.kimi-code/ (OAS hooks not configured)
...
Options:
  ...
  --config <path>     Load install intent from oas-install.json
