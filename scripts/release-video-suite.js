...
const REQUIRED_SOURCE_ASSETS = [
  ...
  {
    id: 'what-is-oas-wide',
    file: 'sf-thread-2-whatisoas.mp4',
    lane: 'what-is-oas',
...
const REQUIRED_SUITE_ARTIFACTS = [
  ...
  },
  {
    ...
    relativePath: 'renders/oas-2-primary-launch-rough-v1.captions.srt',
    kind: 'captions',
  },
  {
    id: 'primary-render-v1',
    relativePath: 'renders/oas-2-primary-launch-rough-v1.mp4',
    kind: 'video',
...
const REQUIRED_PUBLISH_CANDIDATES = [
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-primary-launch.mp4',
    kind: 'video',
    minDurationSeconds: 90,
    maxDurationSeconds: 150,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-primary-launch.captions.srt',
    kind: 'captions',
  },
  {
    id: 'publish-install-proof-wide',
    relativePath: 'renders/publish-candidates/oas-2-install-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-install-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 25,
    maxDurationSeconds: 35,
    minWidth: 1080,
  ...
  {
    id: 'publish-what-is-oas-wide',
    relativePath: 'renders/publish-candidates/oas-2-what-is-oas-wide.mp4',
    kind: 'video',
  ...
  {
    id: 'publish-what-is-oas-vertical',
    relativePath: 'renders/publish-candidates/oas-2-what-is-oas-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-security-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-security-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 45,
    maxDurationSeconds: 60,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-money-proof-wide.mp4',
    kind: 'video',
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-money-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-social-proof-wide.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1920,
  ...
  },
  {
    ...
    relativePath: 'renders/publish-candidates/oas-2-social-proof-vertical.mp4',
    kind: 'video',
    minDurationSeconds: 30,
    maxDurationSeconds: 45,
    minWidth: 1080,
...
function usage() {
  console.log([
    ...
    '',
    'Validates the OAS 2.0 release video production lane for the package.json release version without committing raw media paths.',
    '',
    'Options:',
    '  --format <text|json>     Output format (default: text)',
    '  --json                   Alias for --format json',
    '  --root <dir>             Repository root to inspect (default: cwd)',
    '  --source-root <dir>      Directory containing OAS 2 source media, with optional _edited subdir',
...
function parseArgs(argv) {
  ...
  const parsed = {
    ...
    sourceRoot: process.env.OAS_VIDEO_SOURCE_ROOT || '',
    suiteRoot: process.env.OAS_VIDEO_RELEASE_SUITE_ROOT || '',
    skipProbe: false,
    summary: false,
  };
...
function buildReport(options = {}) {
  ...
  const checks = [
    ...
    makeCheck(
      ...
      'Set OAS_VIDEO_SOURCE_ROOT or pass --source-root to the edited OAS 2 media directory.',
      {
    ...
    makeCheck(
      ...
      'Set OAS_VIDEO_RELEASE_SUITE_ROOT or pass --suite-root to the OAS 2 release suite workspace.',
      {
  ...
  if (!sourceRoot) {
    topActions.push('Set OAS_VIDEO_SOURCE_ROOT to the edited OAS 2 media directory.');
  }

  if (!suiteRoot) {
    topActions.push('Set OAS_VIDEO_RELEASE_SUITE_ROOT to the local release suite workspace.');
  }
...
function renderText(report) {
  const lines = [
    `OAS ${report.release} release video suite`,
