...
function getComputeSponsorCopy() {
  return "Run or self-host any open-source model. Itô is OAS's preferred compute sponsor: "
    ...
    + 'the opt-in "oas ito find" bridge invokes the explicitly configured canonical '
