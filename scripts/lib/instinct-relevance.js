 ...
 *
 * Resolves part (b) of:
 * https://github.com/neal0709/operating-agent-systems/issues/2371
 */
 ...
 * `OAS_INSTINCT_RELEVANCE_RANKING` to `off`, `false`, `0`, or `no`
 * (case-insensitive). Any other value (including unset) keeps ranking on.
 * @returns {boolean}
 */
function isRelevanceRankingEnabled() {
  const raw = process.env.OAS_INSTINCT_RELEVANCE_RANKING;
