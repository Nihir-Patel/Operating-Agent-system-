...
/**
 * OAS agent data root for memory persistence and related state.
 * Defaults to ~/.claude; override with OAS_AGENT_DATA_HOME (e.g. ~/.cursor/oas).
 */
...
/** Get the canonical OAS sessions directory ($OAS_AGENT_DATA_HOME/session-data) */
export function getSessionsDir(): string;

/** Get the legacy sessions directory ($OAS_AGENT_DATA_HOME/sessions) */
...
/** Get the learned skills directory ($OAS_AGENT_DATA_HOME/skills/learned) */
