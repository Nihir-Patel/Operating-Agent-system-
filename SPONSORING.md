...
OAS is maintained as an open-source agent harness operating system across Claude Code, Cursor, OpenCode, Codex, Gemini, Zed, and other agent workflows.
...
- npm downloads (`oas-universal`, `oas-agentshield`)
...
- Project site: [https://oas.tools](https://oas.tools)
