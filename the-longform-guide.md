# The Longform Guide to Operating Agent Systems

![Header: The Longform Guide to Operating Agent Systems](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to Operating Agent Systems](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/neal0709/operating-agent-systems`
...
*Example of session storage -> <https://github.com/neal0709/operating-agent-systems/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/neal0709/operating-agent-systems/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/neal0709/operating-agent-systems/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [operating-agent-systems](https://github.com/neal0709/operating-agent-systems)*
