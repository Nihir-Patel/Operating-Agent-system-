...
Use this playbook when release copy or roadmap text mentions OAS Tools
...
2. Check the current repo and public listing surfaces:
   - `gh api repos/OAS-Tools/OAS-Tools`
   - `https://github.com/marketplace/oas-tools`
...
- `rg -n "billing|Billing|Marketplace|marketplace|subscription|seat|entitlement|plan" README.md docs/releases/2.0.0-rc.1 docs/OAS-2.0-GA-ROADMAP.md`
- `gh api repos/OAS-Tools/OAS-Tools`
- Manual live check of `https://github.com/marketplace/oas-tools`
- `npx --yes markdownlint-cli docs/releases/2.0.0-rc.1/*.md docs/OAS-2.0-GA-ROADMAP.md`
- `git diff --check`
