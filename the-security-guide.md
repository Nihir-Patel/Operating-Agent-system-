...
It's been a while since my last article now. Spent time working on building out the OAS devtooling ecosystem. One of the few hot but important topics during that stretch has been agent security.

Widespread adoption of open source agents is here. OpenClaw and others run about your computer. Continuous run harnesses like Claude Code and Codex (using OAS) increase the surface area; and on February 25, 2026, Check Point Research published a Claude Code disclosure that should have ended the "this could happen but won't / is overblown" phase of the conversation for good. With the tooling reaching critical mass, the gravity of exploits multiplies.
...
And if you are using OAS specifically, this is also the problem space I built AgentShield for: suspicious hooks, hidden prompt injection patterns, over-broad permissions, risky MCP config, secret exposure, and the stuff people absolutely will miss in manual review.
...
Scan your setup: [github.com/neal0709/agentshield](https://github.com/neal0709/agentshield)
...
> [The Shorthand Guide to Operating Agent Systems](https://x.com/nihirpatel/status/2012378465664745795)
>
> [The Longform Guide to Operating Agent Systems](https://x.com/nihirpatel/status/2014040193557471352)
