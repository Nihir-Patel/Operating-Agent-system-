...
5. If site copy matters, include the current OAS landing page and repo/plugin framing.
...
If the user wants Nihir / OAS voice and live sources are thin, start here unless newer source material overrides it:
