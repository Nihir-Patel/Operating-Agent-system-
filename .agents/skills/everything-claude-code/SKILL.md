...
# Operating Agent Systems Conventions

> Generated from [neal0709/operating-agent-systems](https://github.com/neal0709/operating-agent-systems) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in operating-agent-systems.
...
```text
fix: auto-detect OAS root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by [OAS Tools](https://oas.tools). Review and customize as needed for your team.*
