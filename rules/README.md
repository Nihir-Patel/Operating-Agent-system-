...
>
> Use the OAS-owned namespace below for user-level Claude installs. Flat
> package-level destinations can collide with non-OAS rule packs and do not
> match the main README guidance.

```bash
# Create the OAS rule namespace once.
...
cp -r rules/angular ~/.claude/rules/oas/
cp -r rules/vue ~/.claude/rules/oas/
cp -r rules/nuxt ~/.claude/rules/oas/
cp -r rules/python ~/.claude/rules/oas/
cp -r rules/golang ~/.claude/rules/oas/
cp -r rules/web ~/.claude/rules/oas/
cp -r rules/react-native ~/.claude/rules/oas/
cp -r rules/swift ~/.claude/rules/oas/
cp -r rules/php ~/.claude/rules/oas/
cp -r rules/ruby ~/.claude/rules/oas/
