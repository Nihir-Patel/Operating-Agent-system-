...
The script audits the current working directory by default and auto-detects whether the target is the OAS repo itself or a consumer project using OAS.
...
6. Suggested OAS skills to apply next.
