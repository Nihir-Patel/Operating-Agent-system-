/**
 * OAS Plugin for OpenCode
 *
 * This package provides the published OAS OpenCode plugin module:
 ...
 * - Bundled reference config/assets for the wider OAS OpenCode setup
 *
 * Usage:
 *
 ...
 * ```
 *
 * That enables the published plugin module only. For OAS commands, agents,
