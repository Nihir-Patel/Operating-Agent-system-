#!/usr/bin/env node
/**
 * OAS CodeBuddy Installer (Cross-platform Node.js version)
...
function doInstall() {
  ...
  console.log('OAS CodeBuddy Installer');
  console.log('=======================');
  console.log('');
  ...
  // Add manifest itself
  ensureManifestEntry(manifest, '.oas-manifest');
  ...
  console.log('  3. Enjoy the OAS workflows!');
  console.log('');
