/**
 * Behavioral tests for oas_dashboard.py helper functions.
 */
...
const runtimeHelpersPath = path.join(repoRoot, 'scripts', 'lib', 'oas_dashboard_runtime.py');
...
spec = importlib.util.spec_from_file_location("oas_dashboard_runtime", r"""${runtimeHelpersPath}""")
...
spec.loader.exec_module(module)
try:
    module.launch_terminal('/definitely/not/a/real/oas/path')
