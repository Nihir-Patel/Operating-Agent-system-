'use strict';
/**
 * Tests for the proximity message sink (oas-tui messages send) and the
 * deduping dispatcher.
 */
...
test('resolveEccBin: honors explicit override', () => {
  assert.strictEqual(resolveEccBin({ binPath: '/x/oas-tui' }), '/x/oas-tui');
});
