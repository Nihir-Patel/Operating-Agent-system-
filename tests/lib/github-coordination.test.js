...
const DESCRIPTORS = [
  ...
  },
  {
    ...
    fn: () => {
      const state = { schemaVersion: 'oas.github.coordination.v1', kind: 'epic', status: 'available' };
      const body = [
      ...
      assert.strictEqual(result.schemaVersion, 'oas.github.coordination.v1');
    },
  },
  {
    group: 'extractCoordinationState',
  ...
  // renderCoordinationState
  {
    ...
    fn: () => {
      const state = {
        schemaVersion: 'oas.github.coordination.v1', kind: 'epic', status: 'available',
      ...
      assert.ok(rendered.includes('<!-- oas-coordination:start -->'), 'Missing start marker');
      assert.ok(rendered.includes('<!-- oas-coordination:end -->'), 'Missing end marker');
  ...
  },
  {
    ...
    fn: () => {
      const state = {
        schemaVersion: 'oas.github.coordination.v1', kind: 'epic', status: 'claimed',
