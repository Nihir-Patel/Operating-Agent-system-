...
assert.match(discussionWorkflow, /group:\s*oas-discord-announcement-delivery/);
...
assert.match(releaseAnnounceWorkflow, /group:\s*oas-discord-announcement-delivery/);
