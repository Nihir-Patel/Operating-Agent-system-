/**
 * Tests for scripts/hooks/oas-statusline.js
 *
 * Run with: node tests/hooks/oas-statusline.test.js
 */
...
const { formatDuration, buildContextBar, readCurrentTask } = require('../../scripts/hooks/oas-statusline');
...
function makeTempConfig() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'oas-statusline-test-'));
}

function runTests() {
  console.log('\n=== Testing oas-statusline.js ===\n');
