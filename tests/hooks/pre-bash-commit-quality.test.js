...
function inTempRepo(fn) {
  ...
  try {
    ...
    spawnSync('git', ['config', 'user.name', 'OAS Test'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
    spawnSync('git', ['config', 'user.email', 'oas@example.com'], { cwd: repoDir, stdio: 'pipe', encoding: 'utf8' });
