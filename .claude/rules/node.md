# Node.js Rules for operating-agent-systems
...
> Project-specific rules for the OAS codebase. Extends common rules.
...
- Use `run-with-flags.js` wrapper for all hooks so `OAS_HOOK_PROFILE` and `OAS_DISABLED_HOOKS` runtime gating works
