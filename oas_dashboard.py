#!/usr/bin/env python3
"""
OAS Dashboard - Operating Agent Systems GUI
Cross-platform TkInter application for managing OAS components
"""
...
try:
    ...
    sys.stderr.write(
        "OAS Dashboard requires Tkinter, which is missing from this Python install.\n"
...
from scripts.lib.oas_dashboard_runtime import launch_terminal, maximize_window

logger = logging.getLogger(__name__)

# ============================================================================
# DATA LOADERS - Load OAS data from the project
# ============================================================================

def get_project_path() -> str:
    """Get the OAS project path - assumes this script is run from the project dir"""
...
class OASDashboard(tk.Tk):
    """Main OAS Dashboard Application"""
    
    def __init__(self):
        super().__init__()
        
        self.project_path = get_project_path()
        self.title("OAS Dashboard - Operating Agent Systems")
        
        maximize_window(self)
        
        try:
            self.icon_image = tk.PhotoImage(file='assets/images/oas-logo.png')
    ...
    def create_widgets(self):
        ...
        try:
            self.logo_image = tk.PhotoImage(file='assets/images/oas-logo.png')
        ...
        self.title_label = ttk.Label(header_frame, text="OAS Dashboard", font=('Open Sans', 18, 'bold'))
...
Usage: This skill is automatically activated when working with related technologies."""
    ...
    def create_settings_tab(self):
        ...
        about_text = """OAS Dashboard v1.0.0
Operating Agent Systems GUI

A cross-platform desktop application for 
managing and exploring OAS components.

Version: 1.10.0
Project: github.com/neal0709/Operating-Agent-system-"""
