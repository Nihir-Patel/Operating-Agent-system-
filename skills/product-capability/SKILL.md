...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an OAS-native PRD-to-SRS lane instead of vague planning prose.
metadata:
  origin: OAS
---
...
If useful, point to the next OAS-native lane:
...
HANDOFF
- what should happen next and which OAS lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and OAS 2.0 planning surfaces.
