...
| Feature | v2.0 | v2.1 |
|---------|------|------|
| Storage | Global (`~/.claude/homunculus/`) | Project-scoped (`${XDG_DATA_HOME:-~/.local/share}/oas-homunculus/projects/<hash>/`) |
...
Each project gets a 12-character hash ID (e.g., `a1b2c3d4e5f6`). A registry file at `${XDG_DATA_HOME:-~/.local/share}/oas-homunculus/projects.json` maps IDs to human-readable names.
...
2. `$XDG_DATA_HOME/oas-homunculus`
3. `$HOME/.local/share/oas-homunculus`
...
```bash
# Global directories
mkdir -p "${XDG_DATA_HOME:-$HOME/.local/share}/oas-homunculus"/{instincts/{personal,inherited},evolved/{agents,skills,commands},projects}
...
|---------|---------|-------------|
| `OAS_OBSERVER_NOSURVIVE_WARN_AFTER` | `3` | Consecutive non-survivals before the warning is logged |

## File Structure

```
${XDG_DATA_HOME:-~/.local/share}/oas-homunculus/
...
- [OAS-Tools GitHub App](https://github.com/apps/oas-tools) - Generate instincts from repo history
- Homunculus - Community project that inspired the v2 instinct-based architecture (atomic observations, confidence scoring, instinct evolution pipeline)
- [The Longform Guide](https://x.com/nihirpatel/status/2014040193557471352) - Continuous learning section
