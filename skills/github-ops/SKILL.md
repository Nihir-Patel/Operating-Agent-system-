...
For the OAS repository's maintainer release path, especially `OAS-031` and any
follow-up where tag identity, npm provenance, and announcement evidence must
all line up, read [references/oas-release-checklist.md](references/oas-release-checklist.md)
