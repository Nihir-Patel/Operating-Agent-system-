...
description: >-
  Analyze raw prompts, identify intent and gaps, match OAS components
...
Analyze a draft prompt, critique it, match it to OAS ecosystem components,
...
- User says "how should I use OAS for..."
...
- User is asking about OAS configuration (use `configure-oas` instead)
...
### Phase 3: OAS Component Matching

Map intent + scope + tech stack (from Phase 0) to specific OAS components.
...
### Section 2: Recommended OAS Components
...
A compact version for experienced OAS users. Vary by intent type:
...
- "Optimize this prompt for OAS"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt OAS for this task?"
...
|-----------|------------------|
| `configure-oas` | User hasn't set up OAS yet |
