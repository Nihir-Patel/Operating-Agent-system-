...
If the repo has OAS2 state enabled, prefer adding or reading checkpoints through the OAS control pane or state-store-backed scripts instead of scattering untracked notes.
