...
"SKILL.md" keyword
"operating-agent-systems" keyword
```
...
| --- | --- | --- | --- | --- |
| 1 | article-writing | Local OAS | Drafts articles and guides | Not focused on release notes |
| 2 | content-engine | Local OAS | Multi-format content workflow | Heavier than needed |
