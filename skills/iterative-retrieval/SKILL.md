...
- [The Longform Guide](https://x.com/nihirpatel/status/2014040193557471352) - Subagent orchestration section
- `continuous-learning` skill - For patterns that improve over time
- Agent definitions bundled with OAS (manual install path: `agents/`)
