...
## The Pipeline — mixing the OAS video skills

This skill is the conductor. Each OAS skill is an instrument. Do not skip layers.
...
| Step | OAS skill to load | What it does here |
|------|-------------------|-------------------|
