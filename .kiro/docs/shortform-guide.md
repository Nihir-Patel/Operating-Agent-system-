...
git clone https://github.com/yourusername/oas-kiro-public-repo.git
cd oas-kiro-public-repo
...
- **Migration Guide**: `docs/migration-from-oas.md` - For Claude Code users
