...
- Classify OAS surfaces with concrete repo evidence.
- Keep the result to DAILY vs LIBRARY.
- If an install change is needed afterward, hand off to `configure-oas` instead of re-implementing install logic here.
