# Operating Agent Systems'a Katkıda Bulunma
...
OAS, diğer harness'ler için skill alt kümeleri içerir:
...
- **Issue'lar:** [github.com/neal0709/operating-agent-systems/issues](https://github.com/neal0709/operating-agent-systems/issues)
