...
[![npm oas-universal](https://img.shields.io/npm/dw/oas-universal?label=oas-universal%20haftalık%20indirme&logo=npm)](https://www.npmjs.com/package/oas-universal)
[![npm oas-agentshield](https://img.shields.io/npm/dw/oas-agentshield?label=oas-agentshield%20haftalık%20indirme&logo=npm)](https://www.npmjs.com/package/oas-agentshield)
[![GitHub App Install](https://img.shields.io/badge/GitHub%20App-150%20kurulum-2ea44f?logo=github)](https://github.com/marketplace/oas-tools)
...
<img src="../../assets/images/guides/shorthand-guide.png" alt="Operating Agent Systems Kısa Rehberi" />
</a>
</td>
<td width="33%">
<a href="https://x.com/nihirpatel/status/2014040193557471352">
<img src="../../assets/images/guides/longform-guide.png" alt="Operating Agent Systems Uzun Rehberi" />
</a>
</td>
<td width="33%">
...
### v2.0.0-rc.1 — Surface Sync, Operatör İş Akışları ve OAS 2.0 Alpha (Nis 2026)
...
- **OAS 2.0 alpha repoda** — `oas2/` altındaki Rust kontrol katmanı artık yerelde derleniyor ve `dashboard`, `start`, `sessions`, `status`, `stop`, `resume` ve `daemon` komutlarını sunuyor.
- **Ekosistem sağlamlaştırma** — AgentShield, OAS Tools maliyet kontrolleri, billing portal işleri ve web yüzeyi çekirdek plugin etrafında birlikte gelişmeye devam ediyor.
...
- **Harness-first release** — OAS artık açıkça bir agent harness performans sistemi olarak çerçevelendi, sadece bir config paketi değil.
...
- **Hook runtime kontrolleri** — `OAS_HOOK_PROFILE=minimal|standard|strict` ve `OAS_DISABLED_HOOKS=...` hook dosyalarını düzenlemeden runtime gating için.
...
[Tam değişiklik günlüğü için Releases bölümüne bakın](https://github.com/neal0709/operating-agent-systems/releases).
...
/oas:plan "Kullanıcı kimlik doğrulaması ekle"
...
|---------------------|---------------------|------------------|
| Yeni bir feature planla | `/oas:plan "Auth ekle"` | planner |
| Sistem mimarisi tasarla | `/oas:plan` + architect agent | architect |
...
```
/oas:plan "OAuth ile kullanıcı kimlik doğrulaması ekle"
...
Bu en yaygın sorundur. `.claude-plugin/plugin.json`'a bir `"hooks"` alanı **EKLEMEYİN**. Claude Code v2.1+ kurulu plugin'lerden `hooks/hooks.json`'ı otomatik olarak yükler. Açıkça belirtmek duplicate algılama hatalarına neden olur. Bkz. [#29](https://github.com/neal0709/operating-agent-systems/issues/29), [#52](https://github.com/neal0709/operating-agent-systems/issues/52), [#103](https://github.com/neal0709/operating-agent-systems/issues/103).
</details>
...
- **Codex**: macOS app ve CLI için birinci sınıf destek. PR [#257](https://github.com/neal0709/operating-agent-systems/pull/257)'ye bakın.
