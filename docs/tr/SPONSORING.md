...
OAS, Claude Code, Cursor, OpenCode ve Codex app/CLI genelinde açık kaynaklı bir ajan performans sistemi olarak sürdürülmektedir.
...
| Growth Partner | $500/ay | OAS'yi aktif olarak benimseyen ekipler | Pilot avantajları + aylık ofis saatleri senkronizasyonu + iş akışı entegrasyon rehberliği |
...
- npm indirmeleri (`oas-universal`, `oas-agentshield`)
...
- Proje sitesi: [https://oas.tools](https://oas.tools)
