...
```bash
# Weekly downloads
curl -s https://api.npmjs.org/downloads/point/last-week/oas-universal
curl -s https://api.npmjs.org/downloads/point/last-week/oas-agentshield

# Last 30 days
curl -s https://api.npmjs.org/downloads/point/last-month/oas-universal
curl -s https://api.npmjs.org/downloads/point/last-month/oas-agentshield
```

### GitHub repository adoption

```bash
gh api repos/neal0709/Operating-Agent-system- \
...
```bash
gh api repos/neal0709/Operating-Agent-system-/traffic/views
gh api repos/neal0709/Operating-Agent-system-/traffic/clones
```
...
- [OAS Tools Marketplace](https://github.com/marketplace/oas-tools)
...
> OAS is now positioned as an agent harness performance system, not a config repo.
