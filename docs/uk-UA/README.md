<p align="center">
  <img src="../../assets/hero.png" alt="OAS - операційна система для агентних оболонок" width="100%" />
</p>
...
<p align="center">
  ...
  <a href="https://oas.tools"><img src="https://img.shields.io/badge/Website-oas.tools-E07856?logo=googlechrome&logoColor=white" alt="Website" /></a>
  <a href="https://github.com/apps/oas-tools"><img src="https://img.shields.io/badge/GitHub%20App-OAS%20Tools-181717?logo=github&logoColor=white" alt="GitHub App" /></a>
  <a href="../../LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT license" /></a>
</p>

<p align="center">
  <a href="https://github.com/neal0709/Operating-Agent-system-/stargazers"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Fstars&style=flat" alt="Stars" /></a>
  <a href="https://github.com/neal0709/Operating-Agent-system-/network/members"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Fforks&style=flat" alt="Forks" /></a>
  <a href="https://github.com/neal0709/Operating-Agent-system-/graphs/contributors"><img src="https://img.shields.io/github/contributors/neal0709/Operating-Agent-system-?style=flat" alt="Contributors" /></a>
  <a href="https://github.com/marketplace/oas-tools"><img src="https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Finstalls&logo=github" alt="GitHub App installs" /></a>
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/oas-universal"><img src="https://img.shields.io/npm/dw/oas-universal?label=oas-universal&logo=npm" alt="oas-universal npm downloads" /></a>
  <a href="https://www.npmjs.com/package/oas-agentshield"><img src="https://img.shields.io/npm/dw/oas-agentshield?label=oas-agentshield&logo=npm" alt="oas-agentshield npm downloads" /></a>
</p>
...
> [!WARNING]
> **Лише офіційні джерела.** Встановлюйте OAS виключно з перевірених каналів: репозиторій GitHub [github.com/neal0709/Operating-Agent-system-](https://github.com/neal0709/Operating-Agent-system-), пакети npm [`oas-universal`](https://www.npmjs.com/package/oas-universal) та [`oas-agentshield`](https://www.npmjs.com/package/oas-agentshield), [GitHub App](https://github.com/apps/oas-tools), ідентифікатор плагіна `oas@oas`, та вебсайт проєкту [oas.tools](https://oas.tools). Сторонні перезавантаження та неофіційні дзеркала не підтримуються і не перевіряються проєктом та можуть містити шкідливе програмне забезпечення.
...
Це встановлює навички, агенти, команди та керовані плагіном хуки OAS. Якщо ви обираєте цей шлях, зупиніться на цьому. Не запускайте також повне ручне встановлення в Claude Code.

> Керований майстер налаштування пакета з'явиться в `oas-universal` 2.2.0. Поки npm залишається на 2.1.0, використовуйте нативні команди плагіна Claude вище.

<div align="center">

<table aria-label="Основні посилання OAS">
<tr>
<td width="33%" align="center">
  <a href="https://oas.tools/pricing">
    <img src="../../assets/images/community/oas-tools-mark.svg" height="42" alt="OAS Tools" /><br />
    <strong>OAS Pro + GitHub App</strong>
  </a><br />
  <sub><a href="https://github.com/apps/oas-tools">Безкоштовне встановлення</a> · <a href="https://oas.tools/pricing">Приватні репозиторії від $19/місце/міс</a></sub>
</td>
<td width="33%" align="center">
  <a href="https://github.com/sponsors/neal0709">
    <img src="../../assets/images/community/heart.svg" height="42" alt="" /><br />
    <strong>Підтримати OAS</strong>
  </a><br />
...
<sub>**OSS залишається безкоштовним.** Цей репозиторій ліцензований за MIT назавжди. OAS Pro — розміщений GitHub App для приватних репозиторіїв. <a href="https://github.com/sponsors/neal0709">Спонсори</a> та <a href="https://oas.tools/pricing">Pro-підписники</a> фінансують роботу. Саме тому один розробник щотижня випускає оновлення для 7 оболонок.</sub>
...
<p align="center" aria-label="Партнери та спонсори">
  ...
  <a href="https://www.greptile.com/go/oas" title="Greptile"><img src="../../assets/images/sponsors/greptile.png" height="54" alt="Greptile" /></a>&nbsp;&nbsp;&nbsp;
  <a href="https://www.atlascloud.ai/?utm_source=github&amp;utm_medium=link&amp;utm_campaign=OAS" title="Atlas Cloud"><picture><source media="(prefers-color-scheme: dark)" srcset="../../assets/images/sponsors/atlascloud-dark.svg" /><img src="../../assets/images/sponsors/atlascloud.svg" width="154" alt="Atlas Cloud" /></picture></a>&nbsp;&nbsp;&nbsp;
...
<sub><a href="https://github.com/sponsors/neal0709"><strong>Стати спонсором</strong></a> · <a href="../../SPONSORS.md">Рівні спонсорства</a> · <a href="../../SPONSORING.md">Програма спонсорства</a></sub>

</div>

<p align="center"><a href="#встановлення-oas">Перейти до встановлення ↓</a></p>

# OAS

Ваш агент може писати код, але OAS надає йому скоординовану інженерну систему та набір інструментів: він планує перед тим, як будувати, перевіряє зміни тестами, переглядає власну роботу зі свіжого контексту, запам'ятовує важливе та перетворює повторювані перемоги на навички та процеси для повторного використання.
...
| Команди | 94 команди | Зручні точки входу, поки OAS переходить на поверхню, орієнтовану на навички |
...
> [!IMPORTANT]
> Керований майстер налаштування пакета з'явиться в `oas-universal` 2.2.0. Поточний реліз npm, 2.1.0, ще не містить команд керованого налаштування. Використовуйте нативні команди плагіна Claude на початку цього README до публікації 2.2.0.

### Обирайте лише один шлях (на кожну оболонку)

Ви можете використовувати OAS з Claude Code, Codex та іншими оболонками одночасно. Для кожної оболонки обирайте один метод встановлення:
...
**Не накопичуйте методи встановлення.** Встановлення OAS двічі в одну оболонку може продублювати навички, команди, хуки чи конфігурацію; встановлення один раз у кілька оболонок — ні.

Якщо ви вже наклали кілька встановлень і щось виглядає продубльованим, перейдіть одразу до [Скидання / видалення OAS](#скидання--видалення-oas).

**Проблеми зі встановленням?** Відкрийте коротку [форму проблеми встановлення чи виконання](https://github.com/neal0709/Operating-Agent-system-/issues/new?template=install-problem.yml) або запустіть `oas feedback`. OAS ніколи автоматично не завантажує діагностику.

### Деталі для Claude Code

Claude Code володіє цими вбудованими командами, включно з їхніми помилками, коли маркетплейс, плагін чи конфліктуючий рівень уже існує. OAS не може перехопити цей парсер. Якщо будь-яка нативна команда повідомляє про наявне встановлення чи конфлікт рівнів, дочекайтеся керованого налаштування 2.2.0 або вирішіть конфліктуючий рівень плагіна Claude перед повторною спробою; не накладайте ручне встановлення поверх.

Після встановлення OAS `/oas:configure-oas` — це навичка переналаштування в Claude з простором імен. Вона делегує до того ж безпечного потоку налаштування, але доступна лише після встановлення плагіна і не може замінити вбудовану команду `/plugin` Claude Code під час першого встановлення.

Плагіни Claude Code не можуть розповсюджувати `rules`, тому додавайте лише ті пакети правил, які вам справді потрібні:

```bash
git clone https://github.com/neal0709/Operating-Agent-system-.git
cd OAS
mkdir -p ~/.claude/rules/oas
cp -R rules/common ~/.claude/rules/oas/
cp -R rules/typescript ~/.claude/rules/oas/  # замініть на ваш стек
```
...
```json
{
  "extraKnownMarketplaces": {
    "oas": {
      "source": {
        "source": "github",
        "repo": "neal0709/Operating-Agent-system-"
      }
    }
  },
  "enabledPlugins": {
...
<details>
<summary><strong>Примітка щодо іменування та міграції (oas@oas, neal0709/Operating-Agent-system-, oas-universal)</strong></summary>

OAS має три публічних ідентифікатори, і вони не є взаємозамінними:

- Вихідний репозиторій GitHub: `neal0709/Operating-Agent-system-`
- Ідентифікатор marketplace/плагіна Claude: `oas@oas`
- Пакет npm: `oas-universal`

Це навмисно. Встановлення через marketplace/плагін Anthropic прив'язані до канонічного ідентифікатора плагіна, тому OAS використовує `oas@oas`, щоб зберегти назви інструментів і простори імен команд зі слешем достатньо короткими для строгих валідаторів Desktop/API. Старі публікації можуть показувати попередній довгий ідентифікатор marketplace; вважайте це лише застарілим псевдонімом. Окремо, пакет npm навмисно залишився на `oas-universal`, тому встановлення через npm та marketplace навмисно використовують різні назви.

Релізи npm вирізаються за тегом версії, а не за кожним комітом, тому `oas-universal` відстежує релізи (2.1, 2.2, ...), а не кожен push у `main`. Встановлюйте з git, якщо хочете найсвіжішу версію.

Якщо ваше локальне налаштування Claude було стерто чи скинуто, це не означає, що вам потрібно щось перекуповувати. Почніть з `node scripts/oas.js list-installed`, потім запустіть `node scripts/oas.js doctor` та `node scripts/oas.js repair` перед перевстановленням. Зазвичай це відновлює керовані OAS файли без перебудови всього налаштування.
</details>

### Codex App і CLI

Поточні релізи Codex можуть встановлювати OAS як нативний плагін репо-маркетплейсу. Запис маркетплейсу використовує корінь репозиторію, тому кеш Codex отримує маніфест разом з усіма навичками, конфігурацією MCP, середовищем виконання хуків, скриптами та ресурсами, на які є посилання:

```bash
codex plugin marketplace add neal0709/Operating-Agent-system-
codex plugin add oas@oas
codex plugin list --json
node scripts/codex/check-plugin-cache.js
```

Обидві команди додавання ідемпотентні. Щоб оновити пізніше, запустіть `codex plugin marketplace upgrade oas`, а потім `codex plugin add oas@oas`. Codex зберігає стан одного увімкненого плагіна в активному `CODEX_HOME`; він не пропонує рівні `user`, `project` та `local` Claude. Його нативні хуки вимагають явного рішення про довіру і не використовують чотири профілі хуків OAS для Claude. Всередині Codex викликайте `$configure-oas` для керованого потоку, що враховує провайдера.

Старіший шлях `scripts/sync-oas-to-codex.sh` залишається окремим варіантом сумісності для користувачів, які навмисно хочуть скопійовану та злиту конфігурацію в `~/.codex`; він не потрібен для нативного плагіна. Спочатку запустіть Codex один раз, щоб `~/.codex/config.toml` існував, потім:

```bash
git clone https://github.com/neal0709/Operating-Agent-system-.git
cd OAS
npm install
bash scripts/sync-oas-to-codex.sh
```

Ви також можете відкрити репозиторій OAS безпосередньо в Codex для локального налаштування проєкту. Codex читає кореневий `AGENTS.md` та довірену конфігурацію проєкту в `.codex/` без глобальної синхронізації. Не додавайте нативний плагін маркетплейсу поверх потоку синхронізації.

Для навігації по репозиторію, володіння поверхнями та настанов щодо пакетів diff для PR читайте [карту навігації Codex OAS](../../docs/CODEX-NAVIGATION-GUIDE.md). Дивіться [примітки плагіна .codex](../../.codex-plugin/README.md) для деталей нативного життєвого циклу.
...
Клонуйте OAS один раз, потім оберіть ціль, що відповідає вашій оболонці:
...
Для оболонки без нативної цілі OAS використовуйте [посібник з ручної адаптації](../../docs/MANUAL-ADAPTATION-GUIDE.md). Він пояснює, як перенести невеликий набір навичок і робочих інструкцій OAS у чат-подібні інструменти, не вдаючи, що хуки чи нативне виявлення навичок доступні.

Cursor встановлює визначення агентів під `.cursor/agents/oas-*.md`. Нативна поведінка завантаження Cursor може відрізнятися залежно від збірки Cursor. OAS не встановлює кореневий `AGENTS.md` в `.cursor/`. Адаптер тримає контекст Cursor обмеженим його нативними правилами та поверхнями агентів.
...
Використовуйте це, коли хочете правила, агентів, команди, конфігурацію платформи та основні процеси OAS без хуків часу виконання:
...
```bash
node scripts/oas.js consult "security reviews" --target claude
```
...
node scripts/oas.js install --profile minimal --target claude --with capability:machine-learning
```
...
mkdir -p ~/.claude/rules/oas
cp -r rules/common ~/.claude/rules/oas/
cp -r rules/typescript ~/.claude/rules/oas/   # оберіть свій стек

# Лише основні/загальні навички (Claude Code завантажує навички з прямих
# нащадків ~/.claude/skills; не вкладайте ручні встановлення під ~/.claude/skills/oas/)
...
Використовуйте локальні для проєкту правила, коли стандарти OAS мають застосовуватись до одного репозиторію, а не до кожної сесії Claude Code:

```bash
cd your-project
mkdir -p .claude/rules/oas
cp -R /path/to/OAS/rules/common .claude/rules/oas/
cp -R /path/to/OAS/rules/typescript .claude/rules/oas/
```
...
Для вибіркових ручних встановлень Claude виявляє навички як прямих нащадків `~/.claude/skills/`; не вкладайте їх під `~/.claude/skills/oas/`.
...
Якщо ви встановили OAS через `/plugin install`, не копіюйте ці хуки в `settings.json`. Claude Code v2.1+ вже автоматично завантажує `hooks/hooks.json` плагіна, і дублювання їх у `settings.json` спричиняє подвійне виконання та крос-платформні конфлікти хуків.
...
Встановлення плагіна Claude навмисно не вмикають автоматично вбудовані визначення MCP-серверів OAS. Це уникає надто довгих назв MCP-інструментів плагіна на строгих сторонніх шлюзах, зберігаючи ручне налаштування MCP доступним.
...
OAS поставляється рівно з одним конектором за замовчуванням (`chrome-devtools`); все інше — це навичка, що обгортає CLI/REST API, або опційний запис каталогу. Правило та аудит червня 2026 року, який вивів з експлуатації попередні шість конекторів за замовчуванням, знаходяться в [docs/MCP-CONNECTOR-POLICY.md](../../docs/MCP-CONNECTOR-POLICY.md).

Якщо ви вже запускаєте власні копії вбудованих MCP OAS, встановіть:

```bash
export OAS_DISABLED_MCPS="chrome-devtools"
```

Керовані OAS потоки встановлення та синхронізації Codex пропустять чи видалять ці вбудовані сервери замість повторного додавання дублікатів. `OAS_DISABLED_MCPS` — це фільтр встановлення/синхронізації OAS, а не живий перемикач Claude Code.
...
OAS працює через звичайну конфігурацію кожної оболонки, тому ви можете використовувати офіційного провайдера, сумісний власний API-ендпоінт чи шлюз моделей, або модель на власному хостингу без зміни робочих процесів OAS.

Для Claude Code OAS не жорстко прив'язує налаштування транспорту, розміщеного Anthropic. Мінімальний приклад шлюзу:
...
Якщо ваш шлюз перевизначає назви моделей, налаштуйте це в Claude Code, а не в OAS. Хуки, навички, команди та правила OAS не залежать від провайдера моделі, коли CLI `claude` вже працює. Дивіться [документацію Anthropic про LLM-шлюзи](https://docs.anthropic.com/en/docs/claude-code/llm-gateway) та [документацію про конфігурацію моделі](https://docs.anthropic.com/en/docs/claude-code/model-config).

Запускайте чи розміщуйте будь-яку модель з відкритим вихідним кодом за цим шлюзом, використовуючи окремі обчислювальні ресурси та налаштування обслуговування. Якщо вам потрібна GPU-потужність, [Itô](https://compute.itomarkets.com) — бажаний обчислювальний спонсор OAS; підходить будь-який GPU-провайдер. Посилання на спонсорство пасивне: воно не викликає RFQ, не резервує потужність, не надає обчислювальні ресурси та не налаштовує обслуговування. Окремо, `oas ito find` викликає явно налаштований канонічний CLI Itô та подає живий автентифікований RFQ; він не резервує потужність. Кероване виведення через Itô ще не працює наживо.

### Самостійний хостинг Kimi з OAS + обчислювальними ресурсами Itô

Оболонка Kimi Code та шар обслуговування моделі — окремі речі. OAS налаштовує оболонку агента; ви приносите API-ендпоінт чи розміщуєте самостійно модель Kimi з відкритими вагами на власній GPU-потужності. Цей адаптер перевірений проти Kimi Code 0.31.x (`@moonshot-ai/kimi-code`):
...
<td width="33%" align="center">
  <a href="../../.kimi/README.md">
    <img src="../../assets/images/community/oas-tools-mark.svg" height="52" alt="OAS Tools" /><br />
    <strong>3. Запустіть Kimi Code з OAS</strong>
  </a><br />
...
Налаштуйте ендпоінт за [офіційним посібником провайдера](https://moonshotai.github.io/kimi-cli/en/configuration/providers.html) Kimi Code, потім встановіть OAS:

```bash
bash ./install.sh --target kimi --profile minimal
node scripts/oas.js doctor --target kimi
kimi
```

Kimi Code нативно виявляє встановлені інструкції `.kimi-code/AGENTS.md` та процеси `.kimi-code/skills/`; для проєкту `.agents/skills/` — також офіційне місце виявлення. OAS безпечно зливає записи MCP проєкту в `.kimi-code/mcp.json` і не змінює `~/.kimi-code/config.toml` рівня користувача. Kimi Code підтримує нативні хуки, але поточний керований адаптер проєкту OAS їх не налаштовує, тому цей інсталятор не пропонує профілі хуків Kimi. Пробний запуск інсталятора та набір регресійних тестів перевіряють, що кожен керований запис Kimi залишається в межах локального для проєкту кореня `.kimi-code/`.

### Міст CLI обчислень Itô

`oas ito` делегує до окремо встановленого канонічного клієнта Itô; OAS не підтримує другий API-клієнт. `oas ito login [--no-browser]` виконує авторизацію пристрою, відкриває сторінку верифікації Itô за замовчуванням та зберігає токен пристрою в macOS Keychain; `--no-browser` пригнічує передачу сторінки. OAS сам не виконує автоматизацію браузера. `oas ito auth` лише перевіряє і відхиляє `--no-browser`. Доступні операції: `oas ito login`, `oas ito auth`, `oas ito find`, `oas ito status` та окремо захищений `oas ito evals`. Відповідні MCP-інструменти залишаються `ito_auth`, `ito_find` та `ito_status`; `ito_auth` перевіряє наявні облікові дані, а кваліфікація вузла доступна лише через CLI.

Пакет `ito-compute-cli` наразі не опубліковано. Зберіть його локально з репозиторію середовища виконання Itô (приватний, поки стіл зміцнюється; партнери з дизайну отримують доступ) під `cli/ito-compute-cli`, запустіть `npm ci` та `npm run check`, потім встановіть `OAS_ITO_CLI_EXECUTABLE` на абсолютний шлях `dist/bin/ito.js` цієї збірки. Вхід ніколи не успадковує `ITO_API_KEY`; auth, find та status передають `ITO_API_KEY` напряму, коли налаштовано, і `ITO_AUTH_MODE=legacy` не потрібен. `oas ito logout` відкликає поточні облікові дані пристрою і зберігає їхню локальну копію, якщо віддалене відкликання не може бути підтверджене. Токени пристрою за замовчуванням використовують macOS Keychain; явний резервний файл повинен зберігати дозволи директорії/файлу лише для власника. OAS не виявляє цей клієнт, що містить облікові дані, через `PATH`. Дивіться [навичку `ito-compute`](../../skills/ito-compute/SKILL.md) для повного контракту повноважень RFQ та налаштування MCP.

`find` подає живий автентифікований RFQ. Він не резервує потужність. `evals` вимагає одночасно `ITO_ENABLE_SIXTYTWO_LIVE=1` та `--live-sixtytwo`, окремо встановлений `sixtytwo-cli==0.3.33`, явний список вузлів та наявну абсолютну директорію конфігурації. Він не може орендувати, запускати, відновлювати, ремонтувати чи купувати. OAS не надає шлях блокування котирування, покупки, робочого навантаження чи виведення, і ніколи не замінює відсутнього клієнта чи невдалого живого виклику локальним результатом.
</details>

<details>
<summary><strong>Скидання, ремонт чи видалення</strong></summary>

### Скидання / видалення OAS

Якщо OAS здається продубльованим, нав'язливим чи зламаним, перевірте керований стан перед перевстановленням:

```bash
node scripts/oas.js list-installed
node scripts/oas.js doctor
node scripts/oas.js repair
node scripts/oas.js uninstall --dry-run
```
...
Якщо ви йдете, команда видалення друкує опційну [20-секундну форму зворотного зв'язку](https://github.com/neal0709/Operating-Agent-system-/issues/new?template=quick-feedback.yml). Це публічний issue на GitHub, вона ніколи не блокує видалення, і OAS не завантажує діагностику. Ви також можете в будь-який час запустити `oas feedback`, щоб побачити маршрути для проблем, зворотного зв'язку та пропозицій функцій.

Користувачі плагіна повинні видалити плагін з Claude Code, а потім видалити лише ті папки правил, які вони скопіювали вручну і більше не хочуть мати. OAS видаляє лише файли, записані в його стані встановлення. Він не претендує на непов'язані файли у ваших директоріях оболонки.

Якщо ви наклали кілька методів, очищуйте в такому порядку:

1. Видаліть встановлення плагіна Claude Code.
2. Запустіть команду видалення OAS з кореня репозиторію, щоб видалити файли, керовані станом встановлення.
...
> [!WARNING]
> Ці команди пакетного бігуна OAS недоступні в поточному релізі npm, 2.1.0. Не запускайте їх, поки не буде опубліковано `oas-universal` 2.2.0.
...
|---|---|
| npm / npx | `npx oas-universal setup` |
| pnpm | `pnpm dlx oas-universal setup` |
| Yarn 2+ | `yarn dlx oas-universal setup` |
| Bun | `bunx oas-universal setup` |
...
Майстер інвентаризує офіційний маркетплейс і кожен нативний рівень встановлення Claude перед внесенням змін, потім встановлює, оновлює чи безпечно переміщує `oas@oas` до обраного вами рівня. Повторно запускайте ту саму команду, коли хочете оновити OAS, змінити рівень чи змінити профіль хуків. Цей майстер налаштування наразі налаштовує плагін Claude Code; використовуйте мультиоболонковий майстер нижче для Codex чи Kimi Code.
...
|---|---|
| Claude Code | Нативний плагін `oas@oas` з одним рівнем `user`, `project` чи `local` та профілем хуків OAS |
| Codex | Нативний життєвий цикл маркетплейсу/плагіна Codex; перегляд і довіра хуків залишаються за Codex |
| Kimi Code | Керовані файли проєкту під `./.kimi-code`; хуки OAS, налаштування моделі/провайдера та автентифікація не налаштовуються |
...
```bash
npx oas-universal consult "security reviews" --target claude
npx oas-universal install --profile minimal --target claude --with capability:machine-learning
npx oas-universal doctor --target kimi
```

Не використовуйте `npx oas-install --profile minimal --target claude`: `oas-install` — це назва бінарного файлу всередині `oas-universal`, а не окремо опублікований пакет npm.

OAS також постачає розширені керовані адаптери для `cursor`, `antigravity`, `gemini`, `opencode`, `codebuddy`, `joycode`, `qwen`, `zed`, `hermes` та `openclaw`. Ці цілі досі використовують свої задокументовані шляхи `oas install --target ...`, поки кожен адаптер не пройде керовану матрицю життєвого циклу конфліктів, оновлень, ремонту та видалення. Жоден майстер не встановлює мовчки в кожну виявлену оболонку.

## Почніть використовувати OAS

Почніть з процесу, який вам потрібен, а не з повного каталогу.

| Що ви робите | Почніть тут |
|---|---|
| Створюєте функцію | `/oas:plan "опишіть функцію"`, потім `tdd-workflow` |
...
| Аудитуєте конфігурацію агента | `/security-scan` чи `npx -y oas-agentshield scan --path .` |
...
```text
/oas:plan "Додати автентифікацію"
```
...
|--------------|-----------------|------------|
| Спланувати нову функцію | `/oas:plan "Додати автентифікацію"` | planner |
| Спроєктувати архітектуру системи | `/oas:plan` + агент architect | architect |
...
```
/oas:plan "Додати автентифікацію користувача з OAuth"
...
> [!IMPORTANT]
> **НОВЕ В OAS 2.1: Plan Canvas · оболонка Kimi · самостійне обслуговування на GPU Itô.**
> [Дивіться повні примітки до релізу →](https://github.com/neal0709/Operating-Agent-system-/blob/main/docs/releases/2.1.0/release-notes.md)
...
![Plan Canvas demo: reviewing an OAS plan in the browser, scrolling diagrams, attaching an anchored annotation, chatting with the agent, and approving the plan](https://raw.githubusercontent.com/neal0709/Operating-Agent-system-/main/docs/releases/2.1.0/assets/oas-plan-canvas-demo.gif)

Це агностично до оболонки та моделі: простий CLI (`oas-plan-canvas`), що говорить JSON, тому будь-який агент може ним керувати. Спробуйте: попросіть вашого агента виконати `/oas:plan` щось, а потім переглядайте зі сторінки замість терміналу.

[Відкрити план, використаний у цьому демо →](https://github.com/neal0709/Operating-Agent-system-/blob/main/docs/releases/2.1.0/plan-canvas-demo.plan.md)

### Також у 2.1

- **Ціль встановлення Kimi Code** (`--target kimi`): OAS встановлюється нативно в Kimi Code CLI від [Moonshot AI](https://www.moonshot.ai)
- **Самостійний хостинг на GPU**: перевірений шлях з [Itô](https://compute.itomarkets.com), бажаним обчислювальним спонсором OAS, включно з опційним мостом RFQ `oas ito find` (деталі та розкриття вище в опціях встановлення)
...
`oas memory` надає Claude, Codex, Hermes, OpenClaw, Kimi та іншим оболонкам єдиний локальний, доступний для перегляду формат Markdown для тривалого контексту та передавання. Опційний stdio-сервер `oas-memory-mcp` надає ту саму обмежену поверхню збереження/пошуку/читання/діагностики, не вмикаючи себе за замовчуванням. Повні деталі в розділі [Ділитеся контекстом між оболонками](#ділитеся-контекстом-між-оболонками) нижче.
...
| Версія | Основне |
|---|---|
| [v2.0.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v2.0.0) | Операційна система агентних оболонок: крос-оболонкова градація, субстрат площини управління, оркестратори `orch-*`, Discord + бот OAS, політика єдиного конектора MCP |
| [v1.10.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.10.0) | Оновлення поверхні, оператори процеси, альфа-версія OAS 2.0 |
| [v1.9.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.9.0) | Вибіркове встановлення, OAS Tools Pro, 12 мовних екосистем |
| [v1.8.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.8.0) | Продуктивність оболонок та крос-платформна надійність |
| [v1.7.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.7.0) | Крос-платформне розширення та конструктор презентацій |
| [v1.6.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.6.0) | Codex Edition та OAS Tools GitHub App |
| [v1.5.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.5.0) | Universal Edition |
| [v1.4.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.4.0) | Мультимовні правила, майстер встановлення, оркестрація PM2 |
| [v1.3.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.3.0) | Повна підтримка плагіна OpenCode |
| [v1.2.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.2.0) | Уніфіковані команди та навички |
| [v1.1.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.1.0) | Крос-платформна підтримка та виправлення від спільноти |
| [v1.0.0](https://github.com/neal0709/Operating-Agent-system-/releases/tag/v1.0.0) | Офіційний реліз плагіна |
...
Стабільна градація лінійки 2.0: субстрат площини управління (адаптери сесій + інвентаризація MCP), служба життєвого циклу worktree, родина оркестраторів `orch-*` та запуск [спільноти OAS Discord](https://discord.gg/36yGMHGFbR). Повні примітки: [docs/releases/2.0.0/release-notes.md](../../docs/releases/2.0.0/release-notes.md).

### v2.0.0-rc.1: Оновлення поверхні, оператори процеси та альфа OAS 2.0 (квіт. 2026)

- **GUI панель керування**: нова настільна програма на основі Tkinter (`oas_dashboard.py` чи `npm run dashboard`) з перемикачем темної/світлої теми, налаштуванням шрифту та логотипом проєкту в заголовку та панелі задач.
...
- **Розширення операторних і вихідних процесів**: `brand-voice`, `social-graph-ranker`, `connections-optimizer`, `customer-billing-ops`, `oas-tools-cost-audit`, `google-workspace-ops`, `project-flow-ops` та `workspace-surface-audit` доповнюють операторну гілку.
...
- **Пакет навичок Itô для ринків прогнозів**: `ito-market-intelligence`, `ito-basket-compare`, `ito-trade-planner`, `ito-data-atlas-agent`, `prediction-market-oracle-research` та `prediction-market-risk-review` додають публічні, неконсультативні ринкові/кошикові процеси, зберігаючи живий доступ до API Itô окремим від білінгу OAS Tools.
...
- **OAS 2.0 alpha у дереві**: прототип площини управління на Rust у `oas2/` збирається локально та надає команди `dashboard`, `start`, `sessions`, `status`, `stop`, `resume` та `daemon`.
- **Знімки статусу оператора**: `oas status --markdown --write status.md` перетворює локальне сховище стану на портативне передавання, яке охоплює готовність, активні сесії, стан виконання навичок, стан встановлення, очікувані події управління та пов'язані робочі елементи з Linear/GitHub/handoffs.
- **Зміцнення екосистеми**: AgentShield, контроль витрат OAS Tools, робота з білінг-порталом та оновлення вебсайту продовжують поставлятись навколо основного плагіна замість того, щоб дрейфувати в окремі силоси.
...
- **Першочерговий випуск для оболонок**: OAS явно позиціонується як система продуктивності агентних оболонок, а не просто пакет конфігурацій.
...
- **Елементи управління виконанням хуків**: `OAS_HOOK_PROFILE=minimal|standard|strict` та `OAS_DISABLED_HOOKS=...` для управління під час виконання без редагування файлів хуків.
...
- **GitHub Marketplace**: OAS Tools GitHub App доступний на [github.com/marketplace/oas-tools](https://github.com/marketplace/oas-tools) з безкоштовним/pro/enterprise рівнями.
...
- **Виправлено втрату вмісту при імпорті інстинктів**: `parse_instinct_file()` мовчки відкидав увесь вміст після frontmatter (розділи Action, Evidence, Examples) під час `/instinct-import`. ([#148](https://github.com/neal0709/Operating-Agent-system-/issues/148), [#161](https://github.com/neal0709/Operating-Agent-system-/pull/161))

### v1.4.0: Мультимовні правила, майстер встановлення та PM2 (лют. 2026)

- **Інтерактивний майстер встановлення**: нова навичка `configure-oas` забезпечує кероване налаштування з виявленням злиття/перезапису.
...
Повний журнал змін у [Releases](https://github.com/neal0709/Operating-Agent-system-/releases).
</details>
...
```text
/oas:plan "Додати сповіщення про білінг на основі використання"
...
Правила, навички, агенти та хуки вирішують різні проблеми. Тримати ці завдання окремо — ось як OAS додає можливості, не скидаючи весь репозиторій у кожну сесію.
...
Сховище пам'яті OAS надає Claude, Codex, Hermes, OpenClaw, Kimi та іншим оболонкам єдиний локальний, доступний для перегляду формат Markdown для тривалого контексту та передавання. Пам'ять проєкту та команди живе під `.oas/memory/`; пам'ять користувача живе під `~/.oas/memory/`.

```bash
npm install -g oas-universal
oas memory init --scope project
oas memory search "authentication migration" --target-harness codex
oas memory doctor
```

Пам'ять — це неперевірений контекст, а не виконувана політика. Перевіряйте важливі твердження за авторитетними джерелами та переносьте прийняті знання в керовану документацію проєкту. Опційний сервер `oas-memory-mcp` надає ту саму обмежену поверхню збереження, пошуку, читання та діагностики, не вмикаючи себе за замовчуванням.
...
Для опційного доступу через MCP додайте запис `oas-memory-vault` з [`mcp-configs/mcp-servers.json`](../../mcp-configs/mcp-servers.json) до кожної оболонки, якій він потрібен, потім запустіть `oas-memory-mcp`. Сервер надає лише `memory_save`, `memory_search`, `memory_read` та `memory_doctor`. Кожен сервер повинен запускатися з ідентичністю `OAS_MEMORY_HARNESS` у нижньому регістрі; ідентичність прив'язана до сервера і не може надаватися викликачем інструменту. Обсяг користувача додатково вимагає опційне підключення `OAS_MEMORY_ALLOW_USER_SCOPE=1`, кероване оператором. Дивіться [`skills/unified-memory/SKILL.md`](../../skills/unified-memory/SKILL.md) для процесу та меж довіри, і [`docs/design/oas-memory-vault.md`](../../docs/design/oas-memory-vault.md) для контракту можливостей.
</details>
...
<table aria-label="Посібники OAS" width="100%">
<tr>
<td width="33%" align="center">
<a href="../../the-shortform-guide.md">
<img src="../../assets/images/guides/shorthand-guide.png" width="213" height="120" alt="Короткий посібник з OAS" /><br />
<strong>Короткий посібник</strong>
</a>
<br /><sub>Налаштування, основи та використання з першого дня. <b>Читайте спочатку.</b> (<a href="https://x.com/nihir/status/2012378465664745795">нитка</a>)</sub>
</td>
<td width="33%" align="center">
<a href="../../the-longform-guide.md">
<img src="../../assets/images/guides/longform-guide.png" width="213" height="120" alt="Розширений посібник з OAS" /><br />
<strong>Розширений посібник</strong>
</a>
<br /><sub>Економіка контексту, пам'ять, оцінки та паралельні агенти. (<a href="https://x.com/nihir/status/2014040193557471352">нитка</a>)</sub>
</td>
<td width="33%" align="center">
<a href="../../the-security-guide.md">
<img src="../../assets/images/guides/security-guide.png" width="213" height="120" alt="Посібник з безпеки OAS" /><br />
<strong>Посібник з безпеки</strong>
</a>
<br /><sub>Ін'єкція промптів, хуки, MCP та AgentShield. (<a href="https://x.com/nihir/status/2033263813387223421">нитка</a>)</sub>
</td>
</tr>
</table>
...
Запустіть настільну панель керування для візуального дослідження компонентів OAS:

```bash
npm run dashboard
# або
python3 ./oas_dashboard.py
```
...
[Встановити OAS Tools GitHub App](https://github.com/apps/oas-tools) | [oas.tools](https://oas.tools)
...
Використовуйте `/security-scan` у Claude Code для запуску, або додайте до CI через [GitHub Action](https://github.com/neal0709/agentshield).

[GitHub](https://github.com/neal0709/agentshield) | [npm](https://www.npmjs.com/package/oas-agentshield)
</details>
...
Навички є основною поверхнею процесів. Вони можуть викликатися безпосередньо, пропонуватися автоматично та повторно використовуватися агентами. OAS все ще постачає підтримувані `commands/` під час міграції, тоді як застарілі шими коротких назв живуть під `legacy-command-shims/` лише для явного опційного підключення. Нова розробка процесів має відбуватися в `skills/` насамперед.
...
Основний Node.js CLI OAS та керовані інсталятори працюють на **Windows, macOS та Linux**, але опційні можливості не мають повного паритету. Деякі шляхи безперервного навчання, GAN та оркестрації досі вимагають Bash чи Python; оболонки також надають різні API хуків, агентів та навичок.
...
| macOS | Підтримується основний | Автономний шлях GAN shell не сумісний із системним Bash 3.2 і наразі має дефект розбору оцінок ([#2674](https://github.com/neal0709/Operating-Agent-system-/issues/2674)). |
...
| Windows нативний | Підтримується з обмеженнями | Демон спостерігача та записи сховища пам'яті continuous-learning v2 мають відкриті дефекти на нативному Windows ([#2489](https://github.com/neal0709/Operating-Agent-system-/issues/2489), [#2626](https://github.com/neal0709/Operating-Agent-system-/issues/2626)). Опційні функції на основі shell вимагають Git Bash/WSL чи недоступні. |
...
export OAS_INSTINCT_RELEVANCE_RANKING=on

# Зберегти попередження щодо контексту/обсягу/циклів, але пригнічити оцінки витрат API
export OAS_CONTEXT_MONITOR_COST_WARNINGS=off
```

Windows PowerShell:

```powershell
[Environment]::SetEnvironmentVariable('OAS_CONTEXT_MONITOR_COST_WARNINGS', 'off', 'User')
[Environment]::SetEnvironmentVariable('OAS_SESSION_RETENTION_DAYS', '14', 'User')
```
</details>
...
Хуки збереження пам'яті (підсумки сесій, вивчені навички, псевдоніми сесій, метрики) зберігають дані під єдиним кореневим каталогом даних агента. За замовчуванням це `~/.claude`. При використанні OAS у Claude Code та Cursor на одному комп'ютері встановіть окремий корінь для Cursor, щоб два середовища не перезаписували файли сесій одне одного:

```bash
# Кордон лише для Cursor (Claude Code зберігає стандартний ~/.claude)
export OAS_AGENT_DATA_HOME="$HOME/.cursor/oas"
```

Шляхи, що вирішуються під цим коренем:

- `$OAS_AGENT_DATA_HOME/session-data/`: підсумки сесій
- `$OAS_AGENT_DATA_HOME/skills/learned/`: вивчені навички з evaluate-session
- `$OAS_AGENT_DATA_HOME/session-aliases.json`: псевдоніми сесій
- `$OAS_AGENT_DATA_HOME/metrics/`: метрики витрат та активності

Дивіться [neal0709/Operating-Agent-system-#2065](https://github.com/neal0709/Operating-Agent-system-/issues/2065).
</details>
...
| Codex | Підтримувана синхронізація; маркетплейс експериментальний | Конфігурація репозиторію чи `sync-oas-to-codex.sh` | Немає середовища виконання хуків OAS. Пакет маркетплейсу може пропускати спільний вміст репозиторію з кешу Codex; використовуйте синхронізацію для надійного шляху. |
| Cursor | Бета-адаптер проєкту | Вибірковий інсталятор у `.cursor/` | Виявлення агентів залежить від збірки Cursor, а шляхи інсталятора OAS ще не показують ідентичні набори хуків ([#2419](https://github.com/neal0709/Operating-Agent-system-/issues/2419)). |
| OpenCode | Бета зібраний плагін | Зберіть плагін, потім вибірковий інсталятор | OAS постачає підмножину каталогу, а еталонна конфігурація прив'язує моделі Anthropic; оберіть моделі, доступні вашому провайдеру ([#2617](https://github.com/neal0709/Operating-Agent-system-/issues/2617)). |
| GitHub Copilot | Лише інструкції | Закомічені інструкції та файли промптів | Немає хуків OAS, агентів часу виконання, делегування чи нативного виявлення навичок. |
...
| Хуки OAS | Нативні хуки плагіна | Не підтримується | Адаптер хуків Cursor; відмінності шляхів встановлення залишаються | Події плагіна | Не підтримується |
| Конфігурація MCP | Доступна, явна активація | Злиття TOML через синхронізацію | Явна конфігурація проєкту/користувача | Конфігурація провайдера/плагіна | Не надається OAS |
...
OAS надає підтримку Cursor IDE з хуками, правилами, агентами, навичками, командами та конфігами MCP, адаптованими для макету проєктів Cursor.
...
| Агенти | 48 | `.cursor/agents/oas-*.md` при встановленні; з префіксом для уникнення конфліктів з агентами користувача чи маркетплейсу |
...
OAS не встановлює кореневий `AGENTS.md` в `.cursor/`. Cursor трактує вкладені файли `AGENTS.md` як контекст директорії, тому копіювання ідентичності репозиторію OAS в проєкт-хост забруднило б цей проєкт.

Нативна поведінка завантаження Cursor може відрізнятися залежно від збірки Cursor. OAS встановлює агентів як `.cursor/agents/oas-*.md`; якщо ваша збірка Cursor не показує агентів проєкту, ці файли все одно працюють як явні довідкові визначення замість прихованого глобального контексту промпту.

#### Ізоляція пам'яті та даних (Cursor + Claude Code)

Хуки пам'яті OAS повторно використовують ті самі `scripts/hooks/*.js`, що й Claude Code. Для Cursor OAS намагається автоматично тримати пам'ять **поза `~/.claude`**:

1. **Хук `sessionStart` Cursor** (встановлюється в `.cursor/hooks.json` при `--target cursor`) вводить `OAS_AGENT_DATA_HOME` для всієї сесії composer.
2. **Стандарт середовища виконання хуків**: коли присутні `CURSOR_VERSION` чи `CURSOR_PROJECT_DIR`, хуки за замовчуванням використовують `~/.cursor/oas`, якщо змінна середовища не встановлена.
3. **Конфіг проєкту**: `.cursor/oas-agent-data.json` документує та перевизначає шлях (`agentDataHome`).
4. **Завжди-увімкнене правило**: `.cursor/rules/oas-agent-data-home.mdc` нагадує агенту, де живе пам'ять.
...
Щоб **поділитися** пам'яттю з Claude Code навмисно, встановіть `OAS_AGENT_DATA_HOME=~/.claude` у shell чи в `.cursor/oas-agent-data.json`.

Інстинкти continuous learning v2 залишаються окремо під `CLV2_HOMUNCULUS_DIR` (за замовчуванням `~/.local/share/oas-homunculus`).
...
OAS надає підтримуваний шлях репо/синхронізації Codex для macOS-додатка та CLI, з еталонною конфігурацією, Codex-специфічним доповненням AGENTS.md та спільними навичками. Маршрут маркетплейсу OAS залишається експериментальним. Для навігації по репозиторію, володіння поверхнями та настанов щодо пакетів diff для PR почніть з [`docs/CODEX-NAVIGATION-GUIDE.md`](../../docs/CODEX-NAVIGATION-GUIDE.md).

```bash
# Запустіть Codex CLI в репозиторії: AGENTS.md та .codex/ виявляються автоматично
codex

# Автоматичне налаштування: синхронізуйте активи OAS (AGENTS.md, навички, MCP-сервери) у ~/.codex
npm install && bash scripts/sync-oas-to-codex.sh

# Або вручну: скопіюйте еталонну конфігурацію у вашу домашню директорію
cp .codex/config.toml ~/.codex/config.toml
```

Скрипт синхронізації безпечно зливає MCP-сервери OAS в наявний `~/.codex/config.toml`, використовуючи стратегію **лише додавання**: він ніколи не видаляє й не змінює ваші наявні сервери. Запустіть з `--dry-run` для попереднього перегляду змін, чи `--update-mcp`, щоб примусово оновити сервери OAS до останньої рекомендованої конфігурації.

Для Context7 OAS використовує канонічну назву розділу Codex `[mcp_servers.context7]`, все ще запускаючи пакет `@upstash/context7-mcp`. Якщо у вас вже є застарілий запис `[mcp_servers.context7-mcp]`, `--update-mcp` мігрує його до канонічної назви розділу.
...
Codex **ще не забезпечує паритет виконання хуків у стилі Claude**. Примусове виконання OAS там базується на інструкціях через `AGENTS.md`, опційні перевизначення `model_instructions_file` та налаштування пісочниці/затвердження.
...
OAS постачає три приклади конфігурацій ролей:
...
OAS надає підтримку проєктів Zed через консервативний адаптер `.zed` для локальних для проєкту налаштувань, вирівняних правил, агентів, команд та навичок.
...
Адаптер записує керовані OAS файли під `.zed/` і тримає облікові дані BYOK/OpenRouter поза репозиторієм. Налаштуйте обліковий запис Zed чи API-ключі через власний UI налаштувань Zed чи ваші локальні налаштування користувача.
</details>

<details>
<summary><strong>Детальна підтримка OpenCode</strong></summary>

OAS надає бета-інтеграцію плагіна OpenCode з інструкціями, підмножиною каталогу, командами, власними інструментами та подіями хуків. Він не надає паритет функцій з Claude Code, а еталонні ID моделей повинні існувати у налаштованого провайдера користувача.
...
```bash
npm install oas-universal
```

Потім додайте до вашого `opencode.json`:
```json
{
  "plugin": ["oas-universal"]
}
```

Цей запис npm-плагіна вмикає опублікований плагін-модуль OpenCode від OAS (хуки/події та інструменти плагіна). Він **не** автоматично додає повний каталог команд/агентів/інструкцій OAS до конфігурації вашого проєкту.

Для повного налаштування OAS OpenCode або:
...
OAS надає **підтримку GitHub Copilot** для VS Code через нативну систему інструкційних та промпт-файлів Copilot Chat. Додаткові інструменти не потрібні.
...
| Функція OAS | Еквівалент Copilot |
|-------------|-------------------|
...
GitHub Copilot не має системи хуків чи API підагентів, тому автоматизації хуків OAS (автоформат, перевірка TypeScript, збереження сесій, захист dev-сервера) та делегування агентів недоступні. Шар інструкцій та промптів все ж привносить повну філософію кодування OAS (стандарти, безпеку, TDD та процес) у кожну сесію Copilot Chat.
</details>

<details>
<summary><strong>Що змінилося у v2.0.0</strong></summary>

OAS v2.0.0 стабілізує лінійку 2.0 з публічною історією оператора Hermes, 281 навичкою, 67 агентами, 94 командними шимами, адаптерами сесій, інвентаризацією MCP, службами життєвого циклу worktree, процесами оркестраторів та спільнотою OAS Discord.

- [Примітки до релізу v2.0.0](../../docs/releases/2.0.0/release-notes.md)
- [Еталонна архітектура OAS 2.0](../../docs/OAS-2.0-REFERENCE-ARCHITECTURE.md)
...
| `OAS_CONTEXT_MONITOR_COST_WARNINGS` | увімк | **вимк для підписників підписки** | Пригнічує попередження оцінок API-рейту для агента, зберігаючи попередження контексту/обсягу/циклів |
...
Якщо ви використовуєте підписку і оцінки API-рейту монітора контексту не корисні, встановіть `OAS_CONTEXT_MONITOR_COST_WARNINGS=off`. Це лише пригнічує попередження витрат для агента; воно не вимикає попередження про вичерпання контексту, обсяг чи цикли.
</details>
...
- Використовуйте `OAS_DISABLED_MCPS` лише для фільтрації конфігів MCP, згенерованих OAS, під час потоків встановлення/синхронізації
...
**Передісторія:** Це спричинило повторювані цикли виправлення/відкату в цьому репозиторії ([#29](https://github.com/neal0709/Operating-Agent-system-/issues/29), [#52](https://github.com/neal0709/Operating-Agent-system-/issues/52), [#103](https://github.com/neal0709/Operating-Agent-system-/issues/103)). Поведінка змінювалася між версіями Claude Code, що призводило до плутанини. Тепер є регресійний тест для запобігання повторного введення цього.
</details>

## Безпека

Встановлюйте OAS лише з офіційних джерел:

- Репозиторій GitHub: <https://github.com/neal0709/Operating-Agent-system->
- Плагін Claude Code: `oas@oas`
- Пакети npm: [`oas-universal`](https://www.npmjs.com/package/oas-universal) та [`oas-agentshield`](https://www.npmjs.com/package/oas-agentshield)
- GitHub App: <https://github.com/apps/oas-tools>
- Вебсайт: <https://oas.tools>

Скануйте проєкт з AgentShield:

```bash
npx -y oas-agentshield scan --path .
```
...
`OAS_DISABLED_MCPS` — це фільтр встановлення/синхронізації OAS, а не живий перемикач Claude Code.
...
<details>
<summary><strong>OAS з'являється двічі чи хуки спрацьовують двічі</strong></summary>

Звичайна причина — встановлення плагіна Claude, а потім запуск `./install.sh --profile full` поверх нього.

1. Видаліть встановлення плагіна Claude Code.
2. Запустіть `node scripts/oas.js uninstall --dry-run` з чекауту OAS.
...
**НЕ додавайте поле `"hooks"` до `.claude-plugin/plugin.json`.** Claude Code v2.1+ автоматично завантажує `hooks/hooks.json` зі встановлених плагінів. Явне оголошення спричиняє помилки виявлення дублікатів. Дивіться [#29](https://github.com/neal0709/Operating-Agent-system-/issues/29), [#52](https://github.com/neal0709/Operating-Agent-system-/issues/52), [#103](https://github.com/neal0709/Operating-Agent-system-/issues/103).
</details>

<details>
<summary><strong>Маркетплейс Codex встановлюється, але навички не завантажуються</strong></summary>

Запустіть перевірку кешу з чекауту OAS:

```bash
node scripts/codex/check-plugin-cache.js
```

Якщо повідомляється про невирішені батьківські посилання, використовуйте `bash scripts/sync-oas-to-codex.sh`. Реєстрація в `codex plugin list` підтверджує запис маркетплейсу, а не те, що кожен файл, на який є посилання, досягнув кешу плагіна. Завантаження навичок під час виконання з локальних/репо-маркетплейсів все ще ненадійне вище за течією ([openai/codex#26037](https://github.com/openai/codex/issues/26037)); дивіться [#2128](https://github.com/neal0709/Operating-Agent-system-/issues/2128) для повного дослідження.
</details>

<details>
<summary><strong>Моє контекстне вікно скорочується</strong></summary>

Забагато MCP-серверів поглинає ваш контекст. Кожен опис MCP-інструменту витрачає токени з вашого вікна 200k, потенційно скорочуючи його до ~70k. Контекст SessionStart обмежений 8000 символами за замовчуванням; знизьте це за допомогою `OAS_SESSION_START_MAX_CHARS=4000` чи вимкніть за допомогою `OAS_SESSION_START_CONTEXT=off` для локальних моделей чи налаштувань з низьким контекстом.
...
- **Codex**: підтримуваний шлях репо/синхронізації для macOS-додатка та CLI; пакет маркетплейсу OAS залишається експериментальним.
...
Використовуйте [посібник з ручної адаптації](../../docs/MANUAL-ADAPTATION-GUIDE.md), чи відкрийте [обговорення GitHub](https://github.com/neal0709/Operating-Agent-system-/discussions) з назвою оболонки та форматами файлів, навичок, команд і хуків, які вона підтримує.
</details>
...
<details>
<summary><strong>Спонсори та OAS Pro</strong></summary>

OAS залишається безкоштовним, тому що спонсори та Pro-користувачі фінансують роботу. Логотипи спонсорів вгорі цього README; повний список та рівні в [SPONSORS.md](../../SPONSORS.md).

OAS Pro додає аналіз приватних репозиторіїв, аудити, викликані PR, сканування на основі AgentShield, автоматичні перевірки push та PR, об'єднане командне використання та пріоритетну підтримку через розміщений GitHub App.

<table>
<tr>
<td width="25%" align="center"><a href="https://oas.tools/pricing"><strong>OAS Pro</strong><br /><sub>Розміщений GitHub App для приватних репозиторіїв</sub></a></td>
<td width="25%" align="center"><a href="https://github.com/sponsors/neal0709"><strong>Спонсорувати OAS</strong><br /><sub>Фінансувати OSS-роботу</sub></a></td>
<td width="25%" align="center"><a href="https://github.com/neal0709/Operating-Agent-system-/discussions"><strong>Спільнота</strong><br /><sub>Питання, ідеї та Show and Tell</sub></a></td>
<td width="25%" align="center"><a href="https://github.com/apps/oas-tools"><strong>GitHub App</strong><br /><sub>Аудити PR та розміщені процеси</sub></a></td>
</tr>
</table>

[Стати спонсором](https://github.com/sponsors/neal0709) | [Рівні спонсорства](../../SPONSORS.md) | [Програма спонсорства](../../SPONSORING.md)
</details>
...
- **Короткий посібник (Почніть тут):** [Короткий посібник з OAS](https://x.com/nihir/status/2012378465664745795)
- **Розширений посібник (Для досвідчених):** [Розширений посібник з OAS](https://x.com/nihir/status/2014040193557471352)
- **Посібник з безпеки:** [Посібник з безпеки](../../the-security-guide.md) | [Нитка](https://x.com/nihir/status/2033263813387223421)
- **Підписатись:** [@nihir](https://x.com/nihir)
