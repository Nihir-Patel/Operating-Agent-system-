# OAS 1.10.1 release announcement draft

OAS 1.10.1 is the follow-up stabilization release to 1.10.0.
...
- npm/package/release surfaces are aligned and `oas-universal@1.10.0` is live on npm
...
- Claude marketplace/plugin identifier: `operating-agent-systems@operating-agent-systems`
- npm package: `oas-universal`
- GitHub repo: `neal0709/operating-agent-systems`

Those are intentionally different surfaces. The plugin identifier follows Anthropic marketplace rules; the npm package remains `oas-universal`.
