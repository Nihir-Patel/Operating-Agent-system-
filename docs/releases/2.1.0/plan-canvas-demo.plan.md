# OAS: The Agent Harness Operating System

> Plan artifact · generated by `/oas:plan` · review in Plan Canvas, then approve to begin

## What OAS installs into your agent

Your agent can already write code. OAS gives it an engineering system: it plans
...
- [ ] Ship OAS 2.1 release + announcement
