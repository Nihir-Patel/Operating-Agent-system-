# X Thread Draft — OAS v1.10.0

OAS crossed 140K stars and the public surface had drifted too far from the actual repo.
...
OAS 2.0 is no longer just roadmap talk.

the `oas2/` control-plane alpha is in-tree, builds today, and already exposes:
