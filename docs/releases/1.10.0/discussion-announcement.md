...
OAS just crossed **140K stars**, and the public release surface had drifted too far from the actual repo.
...
OAS 2.0 is now **real as an alpha control-plane surface** in-tree under `oas2/`.
...
That does **not** mean the full OAS 2.0 roadmap is done.
...
- OAS 1.x is the battle-tested harness/workflow layer shipping broadly today
- OAS 2.0 is the alpha control-plane growing on top of it
