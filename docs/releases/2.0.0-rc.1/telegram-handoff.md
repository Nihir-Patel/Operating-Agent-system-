...
```text
Use the public OAS release pack in the repo:
...
1. Finalize one strong X thread for OAS v2.0.0-rc.1.
2. Finalize one strong LinkedIn post for OAS v2.0.0-rc.1.
3. Give me one 30-60 second Hermes x OAS video script and one 15-30 second variant.
