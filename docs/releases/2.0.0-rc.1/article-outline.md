# Article Outline - OAS v2.0.0-rc.1

## Working Title

Turning OAS Into a Cross-Harness Operating System
...
- chat, CLI, TUI, cron, and handoffs can sit above the reusable OAS layer
...
- Claude Code remains the core target, but OAS now treats Codex, OpenCode,
...
- AgentShield and OAS Tools work is mirrored into the roadmap so enterprise
