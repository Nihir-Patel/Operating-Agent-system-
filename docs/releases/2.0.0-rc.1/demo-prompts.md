# Hermes x OAS Demo Prompts

## Prompt 1: OAS Builds OAS

Use the current OAS repo and the public release pack at `docs/releases/2.0.0-rc.1/`.

Do 4 things in order:

1. Inspect git status and the current repo diff, then give me a concise OAS v2.0.0-rc.1 PR or release summary that proves OAS is being used to build OAS itself.
...
- one screen capture of Hermes using OAS to ship OAS v2.0.0-rc.1
- one setup walkthrough of the Hermes x OAS workspace
...
Using the OAS v2.0.0-rc.1 release pack, give me:
