# OAS v2.0.0-rc.1 Partner, Sponsor, and Talks Pack
...
| Core revenue lanes | Sponsors, OAS Tools Pro, consulting, talks | Repeatable growth loop | Approval-gated outbound |
...
```text
OAS gives teams one reusable layer for skills, hooks, rules, MCP conventions,
...
```text
OAS 2.0 sponsor slot for cross-harness agent workflows
```
...
I am getting OAS v2.0.0-rc.1 ready for release review.
...
The sponsor fit is pretty direct: OAS reaches the exact builders who are
...
Repo: https://github.com/neal0709/Operating-Agent-system-
Sponsor: https://github.com/sponsors/neal0709
Release notes: https://github.com/neal0709/Operating-Agent-system-/blob/main/docs/releases/2.0.0-rc.1/release-notes.md
...
```text
OAS 2.0 is getting close to rc.1.
...
```text
I am open to a small number of OAS 2.0 implementation sprints for teams that
are standardizing AI coding workflows.

The useful scope is usually:

1. audit the current harness setup;
2. turn repeated workflows into OAS skills, hooks, and rules;
...
```text
OAS started as an open-source workflow layer for Claude Code and is now moving
...
I can show how OAS uses reusable skills, hooks, MCP conventions, release gates,
...
```text
OAS v2.0.0-rc.1 preview pack is ready for final release review.

The main point: OAS 2.0 is a meta-harness for agentic work.
...
- "If your AI coding setup only works in one harness, it is not an operating
  system yet."
- "OAS 2.0 is the shared layer: skills, hooks, MCPs, release gates, and team
...
- The message claims native payments are ready before OAS Tools billing readback
  passes.
...
- Repo: <https://github.com/neal0709/Operating-Agent-system->
- Release notes: <https://github.com/neal0709/Operating-Agent-system-/blob/main/docs/releases/2.0.0-rc.1/release-notes.md>
- Quickstart: <https://github.com/neal0709/Operating-Agent-system-/blob/main/docs/releases/2.0.0-rc.1/quickstart.md>
- Sponsor: <https://github.com/sponsors/neal0709>
- Sponsor tiers: <https://github.com/neal0709/Operating-Agent-system-/blob/main/SPONSORS.md>
- Sponsoring guide: <https://github.com/neal0709/Operating-Agent-system-/blob/main/SPONSORING.md>
