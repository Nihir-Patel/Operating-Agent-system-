...
This rc.1 note records a public teaser skill pack that connects OAS's skill
distribution loop with Itô prediction-market workflows while keeping the two
businesses separate.

OAS remains the open agent-harness substrate and OAS Tools remains the hosted
GitHub App / Pro surface. Itô remains a separate prediction-market basket
business. The link is distribution: OAS can ship reusable skills that make
...
1. OAS users discover useful public prediction-market skills.
...
5. Sanitized patterns can become new OAS skills.

This sends agent/tooling traffic toward Itô without making OAS Tools look like
