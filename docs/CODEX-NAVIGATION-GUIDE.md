# Codex OAS Navigation Map

This guide helps Codex agents navigate OAS without scanning every surface from
...
OAS ships project-local Codex role layers in `.codex/agents/`:
