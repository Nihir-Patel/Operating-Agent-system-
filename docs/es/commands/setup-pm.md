...
Establecer `CLAUDE_PACKAGE_MANAGER` para anular todos los demás métodos de detoasión:
...
## Ejecutar la Detoasión

Para ver los resultados actuales de detoasión del gestor de paquetes:
