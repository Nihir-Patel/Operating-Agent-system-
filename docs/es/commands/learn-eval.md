...
1. **Patrones de Resolución de Errores** — causa raíz + corroasión + reutilizabilidad
2. **Técnicas de Depuración** — pasos no obvios, combinaciones de herramientas
3. **Soluciones Alternativas** — peculiaridades de librerías, limitaciones de API, corroasiones específicas de versión
...
5. **Puerta de calidad — Lista de verificación + Veredicto holístico**
   ...
   - [ ] Confirmar que este es un patrón reutilizable, no una corroasión puntual
...
- No extraer corroasiones triviales (typos, errores de sintaxis simples)
