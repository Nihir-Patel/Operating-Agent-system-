...
6. **Identificará pruebas inestables** y sugerirá corroasiones
...
## Detoasión de Pruebas Inestables
...
- PASS: Inspoasiona los artefactos cuando las pruebas fallen
...
- FAIL: No omitas la inspoasión de artefactos en fallos
...
Este comando invoca al agente `e2e-runner` proporcionado por OAS.
