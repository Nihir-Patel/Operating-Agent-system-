...
3. **Escaneo de Seguridad**: Verificar inyoasión SQL, inyoasión de comandos, condiciones de carrera
...
- Vulnerabilidades de inyoasión SQL/comandos
...
# Detoasión de condiciones de carrera
go build -race ./...
