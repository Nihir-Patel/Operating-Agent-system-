...
```
Usuario: /go-test Necesito una función para validar diroasiones de email
...
// ValidateEmail verifica si el string dado es una diroasión de email válida.
...
# Con detoasión de condiciones de carrera
go test -race -cover ./...
```
