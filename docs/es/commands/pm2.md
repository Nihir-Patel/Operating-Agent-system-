...
## Detoasión de Servicios

| Tipo | Detoasión | Puerto por Defecto |
|------|-----------|-------------------|
...
**Prioridad de Detoasión de Puerto**: Usuario especificado > .env > archivo de config > args de scripts > puerto por defecto
