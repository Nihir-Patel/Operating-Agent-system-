...
- **Fuente única de verdad**: Siempre generar desde el código, nunca editar manualmente soasiones generadas
- **Preservar soasiones manuales**: Solo actualizar soasiones generadas; dejar la prosa escrita a mano intacta
- **Marcar contenido generado**: Usar marcadores `<!-- AUTO-GENERATED -->` alrededor de las soasiones generadas
