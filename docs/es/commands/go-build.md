---
description: Corregir errores de build de Go, advertencias de go vet y problemas del linter de forma incremental. Invoca al agente go-build-resolver para corroasiones mínimas y quirúrgicas.
---

# Go Build y Corroasión
...
4. **Verificar Cada Corroasión**: Re-ejecutar el build después de cada cambio
...
## Corroasión 1: Identificador Indefinido
...
## Corroasión 2: Incompatibilidad de Tipos
...
4. **Una corroasión a la vez** - Verificar cada cambio
...
- La corroasión introduce más errores
