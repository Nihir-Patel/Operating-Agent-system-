...
- Vulnerabilidades de inyoasión SQL
...
|---|---|
| **Corroasión** | Errores lógicos, off-by-ones, manejo de null, casos límite, condiciones de carrera |
...
| **Seguridad** | Inyoasión, brechas de auth, exposición de secretos, SSRF, path traversal, XSS |
...
- Solo cambios de docs/config → Revisión más ligera, enfocada en corroasión
...
gh pr review <NÚMERO> --request-changes --body "<resumen con corroasiones requeridas>"
