...
5. Ejecutar el script que falla -> Verificar la corroasión
...
Corroasiones comunes de memoria:
...
- **Siempre** verificar las formas de los tensores antes y después de la corroasión
...
- La corroasión requiere cambiar fundamentalmente la arquitectura del modelo
...
Corroasión: Cambiado nn.Linear(256, 10) a nn.Linear(512, 10) para coincidir con la salida del encoder
Errores restantes: 0
```
