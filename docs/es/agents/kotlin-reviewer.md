...
- **StateFlow con estado mutable** — Usar coloasiones mutables dentro de StateFlow (debe copiar)
...
- **Exposición de componente exportado** — Activities, services o receivers exportados sin protoasiones adecuadas
