...
2. **Entender el alcance** — Identificar qué archivos cambiaron, a qué funcionalidad/corroasión se relacionan, y cómo se conectan.
...
- **Inyoasión SQL** — Concatenación de cadenas en consultas en lugar de consultas parametrizadas
...
- **Vulnerabilidades CSRF** — Endpoints que cambian estado sin protoasión CSRF
...
Corroasión: Mover a variable de entorno y añadir a .gitignore/.env.example
