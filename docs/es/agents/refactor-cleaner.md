...
1. **Detoasión de Código Muerto** — Encontrar código, exportaciones y dependencias no usadas
...
### 1. Analizar
- Ejecutar herramientas de detoasión en paralelo
...
Antes de eliminar:
- [ ] Las herramientas de detoasión confirman que no se usa
