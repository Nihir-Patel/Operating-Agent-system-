...
1. **Extraer** — Leer JSDoc/TSDoc, soasiones de README, variables de entorno, endpoints de API
...
**OPCIONAL:** Corroasiones menores de bugs, cambios cosméticos, refactorización interna.
