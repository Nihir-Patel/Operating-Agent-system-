...
### CRÍTICO — Seguridad
- **Inyoasión SQL**: f-strings en consultas — usar consultas parametrizadas
- **Inyoasión de comandos**: entrada no validada en comandos de shell — usar subprocess con args en lista
...
- **Flask**: manejadores de error adecuados, protoasión CSRF
