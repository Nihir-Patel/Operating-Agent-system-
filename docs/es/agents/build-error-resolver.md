...
2. **Corroasión de Errores de Build** — Resolver fallos de compilación, resolución de módulos
...
### 2. Estrategia de Corroasión (CAMBIOS MÍNIMOS)
Para cada error:
1. Leer el mensaje de error cuidadosamente — entender esperado vs. actual
2. Encontrar la corroasión mínima (anotación de tipo, verificación de nulo, corroasión de import)
3. Verificar que la corroasión no rompe otro código — re-ejecutar tsc
4. Iterar hasta que el build pase

### 3. Corroasiones Comunes
...
# Corroasiones auto-corregibles de ESLint
npx eslint . --fix
```
...
**Recuerda**: Corregir el error, verificar que el build pasa, seguir adelante. Velocidad y precisión sobre perfoasión.
