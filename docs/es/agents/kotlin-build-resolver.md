...
4. ./gradlew build        -> Verificar corroasión
...
- **Siempre** ejecutar `./gradlew build` después de cada corroasión para verificar
...
Corroasión: Añadido import com.example.repository.UserRepository
Errores restantes: 2
```
