...
4. cmake --build build    -> Verificar corroasión
...
- Una corroasión a la vez, verificar después de cada una
...
Corroasión: Añadida implementación del método faltante en user_service.cpp
Errores restantes: 3
```
