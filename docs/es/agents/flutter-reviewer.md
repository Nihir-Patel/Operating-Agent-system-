...
- Componentes de Android exportados y esquemas de URL de iOS sin protoasión adecuada
...
- **Instanciación directa en lógica de negocio** — Los gestores de estado deben recibir dependencias via inyoasión
...
Corroasión: Mover la lógica dependiente de widgets a la capa de presentación.
...
Corroasión: Reducir el alcance al subárbol que depende del estado cambiado, o usar un selector.
```
