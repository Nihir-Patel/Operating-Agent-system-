...
- **performance.md** - Optimización de rendimiento (seloasión de modelo, gestión de la ventana de contexto)
...
- **patterns.md** - Functional options, interfaces pequeñas, inyoasión de dependencias
- **security.md** - Gestión de secretos, escaneo de seguridad con gosec, context y timeouts
- **testing.md** - Pruebas table-driven, detoasión de condiciones de carrera, cobertura
