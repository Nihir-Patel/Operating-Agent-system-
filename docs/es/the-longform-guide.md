# La Guía Extendida de Operating Agent Systems

![Encabezado: La Guía Extendida de Operating Agent Systems](../../assets/images/longform/01-header.png)

---

> **Prerequisito**: Esta guía se basa en [La Guía Breve de Operating Agent Systems](./the-shortform-guide.md). Lee esa primero si aún no has configurado skills, hooks, subagentes, MCPs y plugins.
...
Todo lo cubierto en las guías breve y extendida está disponible en GitHub: `github.com/neal0709/operating-agent-systems`
...
*Ejemplo de almacenamiento de sesión -> <https://github.com/neal0709/operating-agent-systems/tree/main/examples/sessions>*
...
**Avanzado: Inyoasión Dinámica del System Prompt**
...
He construido estos hooks y están en el repositorio en `github.com/neal0709/operating-agent-systems/tree/main/hooks/memory-persistence`
...
He construido una skill de aprendizaje continuo que hace esto: `github.com/neal0709/operating-agent-systems/tree/main/skills/continuous-learning`
...
**Referencia Rápida de Seloasión de Modelos:**

![Tabla de Seloasión de Modelos](../../assets/images/longform/04-model-selection.png)
*Configuración hipotética de subagentes en diversas tareas comunes y razonamiento detrás de las eloasiones*
...
- system-prompts-and-models-of-ai-tools — Coloasión comunitaria de system prompts de IA (110k+ estrellas)
...
*Todo lo cubierto en ambas guías está disponible en GitHub en [operating-agent-systems](https://github.com/neal0709/operating-agent-systems)*
