...
![OAS - el sistema operativo nativo del harness para trabajo agentivo](../../assets/hero.png)

[![Stars](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Fstars&style=flat)](https://github.com/neal0709/Operating-Agent-system-/stargazers)
[![Forks](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Fforks&style=flat)](https://github.com/neal0709/Operating-Agent-system-/network/members)
[![Contributors](https://img.shields.io/github/contributors/neal0709/Operating-Agent-system-?style=flat)](https://github.com/neal0709/Operating-Agent-system-/graphs/contributors)
[![npm oas-universal](https://img.shields.io/npm/dw/oas-universal?label=oas-universal%20weekly%20downloads&logo=npm)](https://www.npmjs.com/package/oas-universal)
[![npm oas-agentshield](https://img.shields.io/npm/dw/oas-agentshield?label=oas-agentshield%20weekly%20downloads&logo=npm)](https://www.npmjs.com/package/oas-agentshield)
[![GitHub App Install](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.oas.tools%2Fbadge%2Finstalls&logo=github)](https://github.com/marketplace/oas-tools)
...
OAS v2.0.0-rc.1 añade la historia pública del operador Hermes sobre esa capa reutilizable: comienza con la [guía de configuración de Hermes](../HERMES-SETUP.md), luego revisa las [notas de la versión rc.1](../releases/2.0.0-rc.1/release-notes.md) y la [arquitectura multi-harness](../architecture/cross-harness.md).
...
<td width="25%" align="center">
  <a href="https://github.com/neal0709/Operating-Agent-system-/discussions">
...
<td width="25%" align="center">
  <a href="https://github.com/apps/oas-tools">
...
<sub>**El OSS es gratis para siempre.** Este repositorio tiene licencia MIT permanente. OAS Pro es la GitHub App alojada para repositorios privados. Los <a href="https://github.com/sponsors/neal0709">patrocinadores</a> y los <a href="https://oas.tools/pricing">suscriptores Pro</a> financian el trabajo — por eso un solo mantenedor publica semanalmente en 7 harnesses.</sub>
...
<tr>
<td width="33%">
<a href="https://x.com/nihirpatel/status/2012378465664745795">
<img src="../../assets/images/guides/shorthand-guide.png" alt="La Guía Resumida de OAS" />
</a>
</td>
<td width="33%">
<a href="https://x.com/nihirpatel/status/2014040193557471352">
<img src="../../assets/images/guides/longform-guide.png" alt="La Guía Extensa de OAS" />
</a>
</td>
<td width="33%">
<a href="https://x.com/nihirpatel/status/2033263813387223421">
...
| Tema | Qué aprenderás |
|------|----------------|
| Optimización de Tokens | Seloasión de modelos, reducción de system prompts, procesos en segundo plano |
...
### v2.0.0-rc.1 — Actualización de Superficie, Flujos de Trabajo de Operador y Alpha de OAS 2.0 (Abr 2026)

- **Dashboard GUI** — Nueva aplicación de escritorio basada en Tkinter (`oas_dashboard.py` o `npm run dashboard`) con alternancia de tema oscuro/claro, personalización de fuente y logo del proyecto en el encabezado y la barra de tareas.
...
- **Expansión de flujos de trabajo de operador y salida** — `brand-voice`, `social-graph-ranker`, `connections-optimizer`, `customer-billing-ops`, `oas-tools-cost-audit`, `google-workspace-ops`, `project-flow-ops` y `workspace-surface-audit` completan el carril de operador.
...
- **OAS 2.0 alpha incluido en el árbol** — el prototipo del plano de control en Rust en `oas2/` ya compila localmente y expone los comandos `dashboard`, `start`, `sessions`, `status`, `stop`, `resume` y `daemon`. Está disponible como alpha, aún no como versión general.
- **Instantáneas de estado del operador** — `oas status --markdown --write status.md` convierte el almacén de estado local en un informe portátil de transferencia que cubre disponibilidad, sesiones activas, estado de ejecución de skills, estado de la instalación, eventos de gobernanza pendientes y elementos de trabajo vinculados de Linear/GitHub/transferencias. Usa `oas work-items upsert ...` para entradas manuales, `oas work-items sync-github --repo owner/repo` para el estado de la cola de PRs/issues, y `oas status --exit-code` para hacer fallar la automatización cuando la disponibilidad requiere atención.
- **Hardening del ecosistema** — AgentShield, controles de costos de OAS Tools, trabajo en el portal de facturación y actualizaciones del sitio web continúan publicándose junto al plugin principal en lugar de desviarse hacia silos separados.
...
- **Confiabilidad del observador** — Corroasión de explosión de memoria con throttling y muestreo de cola, corroasión de acceso a sandbox, lógica de inicio diferido y guardia de reentrada.
...
- **Hardening de CI** — 19 corroasiones de fallos en pruebas, aplicación de conteos del catálogo, validación del manifiesto de instalación y suite de pruebas completa en verde.

### v1.8.0 — Sistema de Rendimiento del Harness (Mar 2026)

- **Primera versión centrada en el harness** — OAS ahora se enmarca explícitamente como un sistema de rendimiento del harness de agentes, no solo un paquete de configuración.
...
- **Controles de ejecución de hooks** — `OAS_HOOK_PROFILE=minimal|standard|strict` y `OAS_DISABLED_HOOKS=...` para control en tiempo de ejecución sin editar los archivos de hooks.
...
- **GitHub Marketplace** — La GitHub App OAS Tools disponible en [github.com/marketplace/oas-tools](https://github.com/marketplace/oas-tools) con niveles gratuito/pro/empresarial
...
### v1.4.1 — Corroasión de Errores (Feb 2026)

- **Corroasión de pérdida de contenido en importación de instintos** — `parse_instinct_file()` descartaba silenciosamente todo el contenido tras el frontmatter (soasiones Action, Evidence, Examples) durante `/instinct-import`. ([#148](https://github.com/neal0709/Operating-Agent-system-/issues/148), [#161](https://github.com/neal0709/Operating-Agent-system-/pull/161))

### v1.4.0 — Reglas Multi-Lenguaje, Asistente de Instalación y PM2 (Feb 2026)

- **Asistente de instalación interactivo** — La nueva skill `configure-oas` proporciona configuración guiada con detoasión de fusión/sobrescritura
...
Consulta el changelog completo en [Releases](https://github.com/neal0709/Operating-Agent-system-/releases).
...
- **No combines métodos de instalación.** La configuración rota más común es: `/plugin install` primero, luego `install.sh --profile full` o `npx oas-universal install --profile full` después.

Si ya combinaste múltiples instalaciones y hay duplicados, salta directamente a [Restablecer / Desinstalar OAS](#restablecer--desinstalar-oas).

### Ruta sin contexto / sin hooks

Si los hooks te parecen demasiado globales o solo quieres las reglas, agentes, comandos y skills principales de OAS, omite el plugin y usa el perfil manual mínimo:
...
Si no estás seguro de qué perfil o componente de OAS instalar, consulta al asesor empaquetado desde cualquier proyecto:

```bash
npx oas-universal consult "security reviews" --target claude
```

Devuelve los componentes coincidentes, los perfiles relacionados y los comandos de vista previa/instalación. Usa el comando de vista previa antes de instalar si quieres inspoasionar el plan de archivos exacto.

Para flujos de trabajo de ML/MLOps en producción, mantén la instalación opt-in y con alcance de componentes:

```bash
npx oas-universal consult "mlops training model deployment" --target claude
...
OAS tiene tres identificadores públicos que no son intercambiables:

- Repositorio fuente de GitHub: `neal0709/Operating-Agent-system-`
- Identificador de marketplace/plugin de Claude: `oas@oas`
- Paquete npm: `oas-universal`

Esto es intencional. Las instalaciones del marketplace/plugin de Anthropic se identifican por un identificador de plugin canónico, por lo que OAS usa `oas@oas` para mantener los nombres de herramientas y los espacios de nombres de comandos slash lo suficientemente cortos para los validadores estrictos de Desktop/API. Las publicaciones antiguas pueden mostrar el anterior identificador largo del marketplace; trátalo solo como un alias heredado. Por su parte, el paquete npm se mantuvo en `oas-universal`, por lo que las instalaciones de npm y las del marketplace usan intencionalmente nombres diferentes.
...
>
> Si ya instalaste OAS mediante `/plugin install`, **no ejecutes `./install.sh --profile full`, `.\install.ps1 --profile full`, ni `npx oas-universal install --profile full` después**. El plugin ya carga las skills, comandos y hooks de OAS. Ejecutar el instalador completo tras una instalación del plugin copia esas mismas superficies en tus directorios de usuario y puede crear skills duplicadas más comportamiento duplicado en tiempo de ejecución.
>
> Para instalaciones de plugin, copia manualmente solo los directorios `rules/` que quieras bajo `~/.claude/rules/oas/`. Empieza con `rules/common` más un pack de lenguaje o framework que uses realmente. No copies todos los directorios de reglas a menos que quieras explícitamente todo ese contexto en Claude.
>
> Usa el instalador completo solo cuando hagas una instalación completamente manual de OAS en lugar de la ruta del plugin.
>
> Si tu configuración local de Claude fue eliminada o restablecida, eso no significa que necesites volver a comprar OAS. Empieza con `node scripts/oas.js list-installed`, luego ejecuta `node scripts/oas.js doctor` y `node scripts/oas.js repair` antes de reinstalar cualquier cosa. Eso generalmente restaura los archivos gestionados por OAS sin reconstruir tu configuración. Si el problema es el acceso a la cuenta o al marketplace para OAS Tools, gestiona la recuperación de la facturación/cuenta por separado.
...
# Ruta de plugin: copiar solo las reglas de OAS en un espacio de nombres propio
mkdir -p ~/.claude/rules/oas
cp -R rules/common ~/.claude/rules/oas/
cp -R rules/typescript ~/.claude/rules/oas/
...
# Ruta de plugin: copiar solo las reglas de OAS en un espacio de nombres propio
New-Item -ItemType Directory -Force -Path "$HOME/.claude/rules/oas" | Out-Null
Copy-Item -Recurse rules/common "$HOME/.claude/rules/oas/"
Copy-Item -Recurse rules/typescript "$HOME/.claude/rules/oas/"

# Ruta de instalación completamente manual (usa esto en lugar de /plugin install)
# .\install.ps1 --profile full
# npx oas-universal install --profile full
```
...
### Restablecer / Desinstalar OAS

Si OAS parece duplicado, intrusivo o roto, no lo reinstales encima de sí mismo.

- **Ruta del plugin:** elimina el plugin de Claude Code, luego borra las carpetas de reglas específicas que copiaste manualmente bajo `~/.claude/rules/oas/`.
...
Luego elimina los archivos gestionados por OAS:
...
OAS solo elimina los archivos registrados en su estado de instalación. No borrará archivos no relacionados que no haya instalado.

Si combinaste métodos, limpia en este orden:

1. Elimina la instalación del plugin de Claude Code.
2. Ejecuta el comando de desinstalación de OAS desde la raíz del repo para eliminar los archivos gestionados por el estado de instalación.
...
# Los nombres de comandos estilo slash existentes siguen funcionando mientras OAS migra fuera de commands/.

# La instalación por plugin usa la forma canónica con espacio de nombres
/oas:plan "Añadir autenticación de usuario"
...
Lanza el dashboard de escritorio para explorar visualmente los componentes de OAS:
...
### Detoasión del Gestor de Paquetes
...
4. **Archivo de bloqueo**: Detoasión desde package-lock.json, yarn.lock, pnpm-lock.yaml o bun.lockb
...
[Instalar GitHub App](https://github.com/apps/skill-creator) | [oas.tools](https://oas.tools)
...
- **Coloasiones de instintos** - Para continuous-learning-v2
...
Analiza tu configuración de Claude Code en busca de vulnerabilidades, configuraciones incorrectas y riesgos de inyoasión.

```bash
# Análisis rápido (sin instalación necesaria)
npx oas-agentshield scan

# Corroasión automática de problemas seguros
...
**Qué analiza:** CLAUDE.md, settings.json, configuraciones de MCP, hooks, definiciones de agentes y skills en 5 categorías — detoasión de secretos (14 patrones), auditoría de permisos, análisis de inyoasión en hooks, perfilado de riesgo de servidores MCP y revisión de configuración de agentes.

**El flag `--opus`** ejecuta tres agentes Claude Opus 4.6 en un pipeline red-team/blue-team/auditor. El atacante encuentra cadenas de exploits, el defensor evalúa las protoasiones y el auditor sintetiza ambos en una evaluación de riesgo priorizada. Razonamiento adversarial, no solo coincidencia de patrones.
...
Usa `/security-scan` en Claude Code para ejecutarlo, o añádelo a CI con la [GitHub Action](https://github.com/neal0709/agentshield).
...
Claude Code v2.1+ **carga automáticamente** `hooks/hooks.json` de cualquier plugin instalado por convención. Declararlo explícitamente en `plugin.json` provoca un error de detoasión de duplicados:

```
Duplicate hooks file detected: ./hooks/hooks.json resolves to already-loaded file
```

**Historial:** Esto ha causado ciclos repetidos de corroasión/reversión en este repo ([#29](https://github.com/neal0709/Operating-Agent-system-/issues/29), [#52](https://github.com/neal0709/Operating-Agent-system-/issues/52), [#103](https://github.com/neal0709/Operating-Agent-system-/issues/103)). El comportamiento cambió entre versiones de Claude Code, generando confusión. Ahora tenemos una prueba de regresión para prevenir que se reintroduzca.
...
> mkdir -p ~/.claude/rules/oas
> cp -r rules/common ~/.claude/rules/oas/
> cp -r rules/typescript ~/.claude/rules/oas/   # elige tu stack
> cp -r rules/python ~/.claude/rules/oas/
> cp -r rules/golang ~/.claude/rules/oas/
> cp -r rules/php ~/.claude/rules/oas/
>
...
cp -r rules/golang ~/.claude/rules/oas/
cp -r rules/php ~/.claude/rules/oas/
cp -r rules/arkts ~/.claude/rules/oas/
...
No copies el `hooks/hooks.json` del repo directamente en `~/.claude/settings.json` ni en `~/.claude/hooks/hooks.json`. Ese archivo está orientado al plugin/repo y está pensado para instalarse mediante el instalador de OAS o cargarse como plugin, por lo que la copia directa no es una ruta de instalación manual soportada.
...
Si instalaste OAS mediante `/plugin install`, no copies esos hooks en `settings.json`. Claude Code v2.1+ ya carga automáticamente el `hooks/hooks.json` del plugin, y duplicarlos en `settings.json` provoca ejecución duplicada y conflictos de hooks multiplataforma.

Nota para Windows: el directorio de configuración de Claude es `%USERPROFILE%\\.claude`, no `~/claude`.

#### Configurar MCPs

Las instalaciones de plugin de Claude intencionalmente no habilitan automáticamente las definiciones de servidores MCP empaquetadas en OAS. Esto evita nombres de herramientas MCP demasiado largos en puertas de acceso estrictas de terceros mientras mantiene la configuración manual de MCP disponible.
...
Si ya ejecutas tus propias copias de los MCPs empaquetados en OAS, establece:

```bash
export OAS_DISABLED_MCPS="github,context7,exa,playwright,sequential-thinking,memory"
```

Los flujos de instalación y sincronización de Codex gestionados por OAS omitirán o eliminarán esos servidores empaquetados en lugar de volver a añadir duplicados. `OAS_DISABLED_MCPS` es un filtro de instalación/sincronización de OAS, no un interruptor en tiempo de ejecución de Claude Code.
...
Las skills son la superficie principal de flujo de trabajo. Pueden invocarse directamente, sugerirse automáticamente y ser reutilizadas por agentes. OAS sigue enviando `commands/` mantenidas durante la migración, mientras que los shims de nombres cortos retirados están en `legacy-command-shims/` solo para opt-in explícito. El nuevo desarrollo de flujos de trabajo debe aterrizar primero en `skills/`.
...
|-----------|---------------------|--------------|
| Planificar una nueva feature | `/oas:plan "Añadir auth"` | planner |
| Diseñar arquitectura del sistema | `/oas:plan` + agente architect | architect |
...
```
/oas:plan "Añadir autenticación de usuario con OAuth"
...
skill tdd-workflow                            → tdd-guide: escribe una prueba que falle y lo reproduzca
                                              → implementa la corroasión, verifica que la prueba pase
...
Este es el problema más común. **NO añadas un campo `"hooks"` a `.claude-plugin/plugin.json`.** Claude Code v2.1+ carga automáticamente `hooks/hooks.json` de los plugins instalados. Declararlo explícitamente provoca errores de detoasión de duplicados. Consulta [#29](https://github.com/neal0709/Operating-Agent-system-/issues/29), [#52](https://github.com/neal0709/Operating-Agent-system-/issues/52), [#103](https://github.com/neal0709/Operating-Agent-system-/issues/103).
</details>

<details>
<summary><b>¿Puedo usar OAS con Claude Code en un endpoint de API personalizado o un gateway de modelos?</b></summary>

Sí. OAS no tiene configuraciones de transporte alojadas en Anthropic. Se ejecuta localmente a través de la superficie CLI/plugin normal de Claude Code, por lo que funciona con:
...
Si tu gateway reasigna nombres de modelos, configúralo en Claude Code en lugar de en OAS. Los hooks, skills, comandos y reglas de OAS son agnósticos al proveedor de modelos una vez que el CLI `claude` ya funciona.
...
Demasiados servidores MCP consumen tu contexto. Cada descripción de herramienta MCP consume tokens de tu ventana de 200k, potencialmente reduciéndola a ~70k. El contexto de SessionStart está limitado a 8000 caracteres por defecto; redúcelo con `OAS_SESSION_START_MAX_CHARS=4000` o desactívalo con `OAS_SESSION_START_CONTEXT=off` para configuraciones de bajo contexto o modelo local.
...
- **Codex**: Soporte de primera clase para la app macOS y CLI, con guardias de deriva del adaptador y fallback de SessionStart. Consulta PR [#257](https://github.com/neal0709/Operating-Agent-system-/pull/257).
...
Estos no están empaquetados con OAS y no son auditados por este repo, pero vale la pena conocerlos si estás explorando el ecosistema más amplio de skills de Claude Code:

- [claude-seo](https://github.com/AgriciDaniel/claude-seo) — Coloasión de skills y agentes centrados en SEO
- [claude-ads](https://github.com/AgriciDaniel/claude-ads) — Coloasión de flujos de trabajo de auditoría de anuncios y crecimiento de pago
- [claude-cybersecurity](https://github.com/AgriciDaniel/claude-cybersecurity) — Coloasión de skills y agentes orientados a seguridad

---

## Soporte para Cursor IDE

OAS proporciona soporte para Cursor IDE con hooks, reglas, agentes, skills, comandos y configuraciones de MCP adaptados para el diseño de proyecto de Cursor.
...
| Agentes | 48 | `.cursor/agents/oas-*.md` cuando se instala; con prefijo para evitar colisiones con agentes de usuario o marketplace |
...
OAS no instala el `AGENTS.md` raíz en `.cursor/`. Cursor trata los archivos `AGENTS.md` anidados como contexto de directorio, por lo que copiar la identidad del repo de OAS en un proyecto host contaminaría ese proyecto.

El comportamiento de carga nativo de Cursor puede variar según la versión. OAS instala agentes como `.cursor/agents/oas-*.md`; si tu versión de Cursor no expone los agentes del proyecto, esos archivos siguen funcionando como definiciones de referencia explícitas en lugar de contexto de prompt global oculto.
...
OAS proporciona **soporte de primera clase para Codex** tanto para la app macOS como para el CLI, con una configuración de referencia, un suplemento AGENTS.md específico de Codex y skills compartidas.
...
# Configuración automática: sincronizar activos de OAS (AGENTS.md, skills, servidores MCP) en ~/.codex
...
El script de sincronización fusiona de forma segura los servidores MCP de OAS en tu `~/.codex/config.toml` existente usando una estrategia **solo de adición** — nunca elimina ni modifica tus servidores existentes. Ejecuta con `--dry-run` para previsualizar los cambios, o `--update-mcp` para forzar la actualización de los servidores OAS a la configuración recomendada más reciente.
...
OAS proporciona **soporte completo para OpenCode** incluyendo plugins y hooks.
...
OAS proporciona **soporte para GitHub Copilot** para VS Code mediante el sistema nativo de archivos de instrucciones y prompts de Copilot Chat — sin herramientas adicionales necesarias.
...
| Prompt de corroasión de build | `.github/prompts/build-fix.prompt.md` | Resolución sistemática de errores de build y CI |
...
2. Haz clic en el icono de **clip / adjuntar** y seloasiona **Prompt...**, o escribe `/` y elige un prompt.
3. Seloasiona el prompt (por ejemplo, `plan`, `tdd`, `security-review`).

---

## Compatibilidad Cross-Tool

OAS es el **primer plugin que maximiza todas las principales herramientas de codificación con IA**. Así se compara cada harness:
...
| `OAS_CONTEXT_MONITOR_COST_WARNINGS` | on | **off para suscriptores** | Suprime las advertencias de estimación de tasa de API frente al agente manteniendo las advertencias de contexto/alcance/bucle |
...
Proyectos construidos sobre o inspirados en OAS:
...
¿Construiste algo con OAS? Abre un PR para añadirlo aquí.
...
[**Conviértete en Patrocinador**](https://github.com/sponsors/neal0709) | [Niveles de Patrocinio](SPONSORS.md) | [Programa de Patrocinio](SPONSORING.md)

---

## Historial de Estrellas

[![Star History Chart](https://api.star-history.com/svg?repos=neal0709/Operating-Agent-system-&type=Date)](https://star-history.com/#neal0709/Operating-Agent-system-&Date)

---

## Enlaces

- **Guía Resumida (Empieza aquí):** [La Guía Resumida de Operating Agent Systems](https://x.com/nihirpatel/status/2012378465664745795)
- **Guía Extensa (Avanzado):** [La Guía Extensa de Operating Agent Systems](https://x.com/nihirpatel/status/2014040193557471352)
- **Guía de Seguridad:** [Guía de Seguridad](../../the-security-guide.md) | [Hilo](https://x.com/nihirpatel/status/2033263813387223421)
- **Seguir:** [@nihirpatel](https://x.com/nihirpatel)
