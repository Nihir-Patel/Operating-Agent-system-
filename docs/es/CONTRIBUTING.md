# Contribuir a Operating Agent Systems
...
# 3. Añadir tu contribución (ver soasiones abajo)
...
- renombra la skill cuando OAS cambie o amplíe materialmente la superficie
- prefiere reglas, skills, scripts y MCPs nativos de OAS sobre nuevas dependencias de terceros por defecto
...
OAS incluye subconjuntos de skills para otros harnesses:
...
- **Issues:** [github.com/neal0709/operating-agent-systems/issues](https://github.com/neal0709/operating-agent-systems/issues)
- **X/Twitter:** [@nihirpatel](https://x.com/nihirpatel)
