...
Problemas comunes y soluciones para el plugin Operating Agent Systems (OAS).
...
- Fallos en la detoasión del proyecto
...
**Soluciones:**
```bash
# Primero inspoasiona qué sabe OAS sobre esta máquina
oas list-installed
oas doctor
oas repair
...
# Inspoasiona la caché del plugin antes de cambiarla
...
# Si el problema es el acceso al marketplace/cuenta, usa la recuperación de cuenta/facturación de OAS Tools por separado; no uses la reinstalación como sustituto de la recuperación de cuenta
...
### Falla la Detoasión del Gestor de Paquetes
...
- Múltiples archivos de bloqueo confunden la detoasión
...
1. **Revisa los Issues de GitHub**: [github.com/neal0709/operating-agent-systems/issues](https://github.com/neal0709/operating-agent-systems/issues)
