...
- Agregar limitación de velocidad o protoasión contra fuerza bruta
...
Usar la diroasión remota real de la solicitud servlet, o una identidad autenticada
...
public class RateLimitFilter implements ContainerRequestFilter {
  ...
  private String getClientIdentifier() {
    // Usar la diroasión remota provista por el contenedor (no X-Forwarded-For).
...
- Usar consultas parametrizadas para prevenir inyoasión SQL
