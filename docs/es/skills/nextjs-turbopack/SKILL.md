...
- **Bundle Analyzer (Next.js 16.1+)**: Bundle Analyzer experimental para inspoasionar la salida y encontrar dependencias pesadas; habilitarlo mediante configuración o flag experimental (ver documentación de Next.js para tu versión).
