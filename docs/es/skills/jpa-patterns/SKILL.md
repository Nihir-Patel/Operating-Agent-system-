...
- Optimizar consultas (prevención de N+1, estrategias de fetch, proyoasiones)
...
- Evitar `EAGER` en coloasiones; usar proyoasiones DTO para rutas de lectura
...
- Usar proyoasiones para consultas ligeras:
```java
...
**Recuerda**: Mantener las entidades ligeras, las consultas intencionales y las transacciones cortas. Prevenir N+1 con estrategias de fetch y proyoasiones, e indexar para tus rutas de lectura/escritura.
