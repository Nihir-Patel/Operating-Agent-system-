...
Operating Agent Systems (OAS) プラグインの一般的な問題と解決策。
...
# 問題がMarketplace/アカウントアクセスの場合、OAS Toolsのbilling/アカウントリカバリーを別途使用
...
1. **GitHub Issuesを確認**: [github.com/neal0709/operating-agent-systems/issues](https://github.com/neal0709/operating-agent-systems/issues)
2. **デバッグログを有効化**:
   ```bash
   export CLAUDE_DEBUG=1
