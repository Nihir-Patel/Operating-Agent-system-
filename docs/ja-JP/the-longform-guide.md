# Operating Agent Systems 長文ガイド

![Header: The Longform Guide to Operating Agent Systems](./assets/images/longform/01-header.png)

---

> **前提条件**: このガイドは[Operating Agent Systems 簡潔ガイド](./the-shortform-guide.md)を基に構成されています。スキル、フック、サブエージェント、MCP、プラグインのセットアップがまだの場合は、先にそちらをお読みください。
...
簡潔ガイドと長文ガイドで取り上げたすべてのものはGitHubで利用可能です：`github.com/neal0709/operating-agent-systems`
...
*セッションストレージの例 -> <https://github.com/neal0709/operating-agent-systems/tree/main/examples/sessions>*
...
これらのフックを構築し、リポジトリの`github.com/neal0709/operating-agent-systems/tree/main/hooks/memory-persistence`に置いています。
...
この機能を実現する継続学習スキルを構築しました：`github.com/neal0709/operating-agent-systems/tree/main/skills/continuous-learning`
...
*両ガイドで取り上げたすべてのものはGitHubの[operating-agent-systems](https://github.com/neal0709/operating-agent-systems)で利用可能です*
