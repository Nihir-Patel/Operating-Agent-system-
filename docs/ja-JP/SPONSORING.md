...
OASはClaude Code、Cursor、OpenCode、Codex app/CLIにまたがるオープンソースのエージェントハーネスパフォーマンスシステムとして維持されています。
...
| グロースパートナー | $500/月 | OASを積極的に導入するチーム | パイロット特典 + 月次オフィスアワー同期 + ワークフロー統合ガイダンス |
...
- npmダウンロード数（`oas-universal`、`oas-agentshield`）
...
- プロジェクトサイト: [https://oas.tools](https://oas.tools)
