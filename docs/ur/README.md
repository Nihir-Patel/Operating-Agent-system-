...
![OAS - ایجنٹک کام کے لیے ہارنس-نیٹو آپریٹر سسٹم](../../assets/hero.png)
...
OAS v2.0.0-rc.1 اس قابل استعمال پرت پر عوامی Hermes آپریٹر کہانی شامل کرتا ہے: [Hermes سیٹ اپ گائیڈ](../../docs/HERMES-SETUP.md) سے شروع کریں، پھر [rc.1 ریلیز نوٹس](../../docs/releases/2.0.0-rc.1/release-notes.md) اور [کراس-ہارنس آرکیٹیکچر](../../docs/architecture/cross-harness.md) دیکھیں۔
...
<sub>**OSS مفت رہتا ہے۔** یہ ریپو ہمیشہ کے لیے MIT لائسنس یافتہ ہے۔ OAS Pro نجی ریپوز کے لیے ہوسٹڈ GitHub App ہے۔ <a href="https://github.com/sponsors/neal0709">اسپانسرز</a> اور <a href="https://oas.tools/pricing">Pro سبسکرائبرز</a> اس کام کو فنڈ کرتے ہیں۔</sub>
...
# OAS-owned نیم اسپیس میں rules کاپی کریں
mkdir -p ~/.claude/rules/oas
cp -R rules/common ~/.claude/rules/oas/
cp -R rules/typescript ~/.claude/rules/oas/  # اپنی زبان منتخب کریں
```
...
| --------------- | ------------------- | ----- |
| نئی feature منصوبہ بنانا | `/oas:plan "Auth شامل کریں"` | planner |
| سسٹم آرکیٹیکچر ڈیزائن | `/oas:plan` + architect agent | architect |
...
**کیا میں OAS کو صرف کچھ اجزاء کے ساتھ استعمال کر سکتا ہوں؟**
...
ہاں۔ OAS کراس-پلیٹ فارم ہے — Claude Code، Cursor، OpenCode، Codex، GitHub Copilot، Gemini، Zed، اور مزید کے ساتھ۔
