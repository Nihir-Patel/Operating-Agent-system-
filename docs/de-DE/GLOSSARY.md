...
Einheitliches Terminologie-Glossar für die deutsche (de-DE) Übersetzung von OAS.

Leitlinie: Etablierte englische Fachbegriffe und OAS-Oberflächennamen (`agents/`, `skills/`,
...
|---------|---------|-------|
| Agent | Agent | bleibt englisch — OAS-Oberfläche (`agents/`) |
| Skill | Skill | bleibt englisch — OAS-Oberfläche (`skills/`) |
| Hook | Hook | bleibt englisch — OAS-Oberfläche (`hooks/`) |
| Command | Command | bleibt englisch als OAS-Oberfläche (`commands/`); generisch sonst „Befehl“ |
| Rule | Rule | bleibt englisch als OAS-Oberfläche (`rules/`); generisch sonst „Regel“ |
| Harness | Harness | bleibt englisch — keine etablierte deutsche Entsprechung |
| Instinct | Instinct | bleibt englisch — OAS-Begriff aus Continuous Learning |
...
| Continuous Learning | Continuous Learning | OAS-Feature-Name bleibt englisch; beschreibend „kontinuierliches Lernen“ |
| Memory | Memory | als OAS-Konzept englisch; generisch „Speicher“ |
