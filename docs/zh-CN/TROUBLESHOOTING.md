...
Operating Agent Systems (OAS) 插件的常见问题与解决方案。
...
1. **检查 GitHub Issues**：[github.com/neal0709/operating-agent-systems/issues](https://github.com/neal0709/operating-agent-systems/issues)
2. **启用调试日志记录**：
   ```bash
   export CLAUDE_DEBUG=1
