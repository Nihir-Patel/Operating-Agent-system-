...
OAS 2.0 needs an evidence-driven harness evaluation loop that can compare
...
- OAS Tools: route evaluator findings into PR comments, check runs, and Linear
...
It models the rule Nihir set during the May 2026 cleanup: stale closure is
...
OAS Tools already flags missing RAG/evaluator evidence for retrieval,
...
Future OAS Tools work should consume these artifacts as fixture shape before it
...
work should consume these fixtures from OAS Tools before adding hosted
