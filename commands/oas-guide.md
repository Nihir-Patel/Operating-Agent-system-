---
description: Navigate OAS's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /oas-guide

Use this command as a conversational map of Operating Agent Systems. It should help the user discover the right OAS surface for their task without dumping the entire README or stale catalog counts.
...
/oas-guide hooks
/oas-guide install
/oas-guide find: <query>
/oas-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside OAS
...
- `/project-init` for stack-aware OAS onboarding of a target project
