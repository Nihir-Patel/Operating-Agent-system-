# Contributing to Operating Agent Systems
...
```bash
# 1. Fork and clone
gh repo fork neal0709/Operating-Agent-system- --clone
cd OAS
...
- rename the skill when OAS materially changes or expands the surface
- prefer OAS-native rules, skills, scripts, and MCPs over new default third-party dependencies
...
OAS ships skill subsets for other harnesses:
...
- **Issues:** [github.com/neal0709/Operating-Agent-system-/issues](https://github.com/neal0709/Operating-Agent-system-/issues)
